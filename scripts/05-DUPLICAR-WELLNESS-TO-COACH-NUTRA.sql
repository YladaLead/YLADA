-- =====================================================
-- SCRIPT 05: DUPLICAR TEMPLATES WELLNESS → COACH E NUTRA
-- =====================================================
-- Cria versões Coach e Nutra de todos os templates Wellness
-- Templates desativados por padrão (ativar depois)
-- =====================================================

-- =====================================================
-- PARTE 1: DUPLICAR WELLNESS → COACH
-- =====================================================
...
-- =====================================================
-- PARTE 2: DUPLICAR WELLNESS → NUTRA
-- =====================================================
...
-- ✅ Templates Coach e Nutra criados com sucesso!
