-- =====================================================
-- CORRIGIR ASSINATURA: Cintia Campos (Cynthia)
-- Email: nutricyncampos@gmail.com
-- Pagamento MP aprovado: transação 145653257734 - Venda por assinatura R$ 97,00 (Nutri Mensal)
-- Referência: nutri_monthly_temp_nutricyncampos@gmail.com
-- Objetivo: Criar assinatura ativa para parar de aparecer "Sem assinatura / Nunca assinou"
-- =====================================================
...
DECLARE
  ...
  v_email TEXT := 'nutricyncampos@gmail.com';
  v_area TEXT := 'nutri';
  v_mp_payment_id TEXT := '145653257734';
BEGIN
  -- Buscar user_id
  ...
  -- Registrar o pagamento em payments (histórico e idempotência do webhook)
  BEGIN
...
WHERE LOWER(up.email) = LOWER('nutricyncampos@gmail.com')
