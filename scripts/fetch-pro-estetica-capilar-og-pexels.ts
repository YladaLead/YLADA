 ...
 * Uso: pnpm og:pexels-capilar  |  npx tsx scripts/fetch-pro-estetica-capilar-og-pexels.ts
 */
...
const OUT_DIR = resolve(process.cwd(), 'public/images/og/pro-estetica-capilar')
const LISTA_PATH = resolve(process.cwd(), 'scripts/data/pro-estetica-capilar-og-pexels-queries.json')
...
async function main() {
  ...
  const reportPath = resolve(OUT_DIR, 'og-pexels-capilar-ultima-execucao.json')
  await writeFile(
    reportPath,
