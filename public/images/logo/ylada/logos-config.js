...
export function getLogoPorCor(cor = 'azul-claro', formato = 'horizontal') {
  if (formato === 'horizontal') {
    if (cor === 'azul-claro' || cor === 'azul') {
      return logos.horizontal.azulClaro.oficial
    }
    return logos.horizontal[cor]?.principal || logos.horizontal.azulClaro.oficial
  } else {
    if (cor === 'azul-claro' || cor === 'azul') {
      return logos.quadrado.azulClaro.oficial
    }
    return logos.quadrado[cor]?.principal || logos.quadrado.azulClaro.oficial
  }
}

// Função helper para obter logo oficial
export function getLogoOficial(formato = 'horizontal') {
  if (formato === 'horizontal') {
    return logos.horizontal.azulClaro.oficial
  }
  return logos.quadrado.azulClaro.oficial
...
// Exemplo de uso:
// import { logos, getLogoOficial, getLogoPorCor } from '/images/logo/ylada/logos-config'
// <img src={logos.principal} alt="YLADA" /> // Logo horizontal oficial (azul 30)
// <img src={logos.quadrado} alt="YLADA" /> // Logo quadrado oficial (azul 31)
// <img src={getLogoOficial('horizontal')} alt="YLADA" />
// <img src={getLogoOficial('quadrado')} alt="YLADA" />
