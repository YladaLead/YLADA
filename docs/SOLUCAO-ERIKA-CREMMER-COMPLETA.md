# 🔧 Solução Completa: Érika Cremmer - Conta Apagada e Pagamento Realizado
...
### ETAPA 1: Criar Conta (Interface Admin)
...
Isso cria a conta e perfil dela.
...
```sql
-- =====================================================
-- CONVERTER ASSINATURA GRATUITA PARA PAGA - ÉRIKA CREMMER
-- =====================================================
...
1. ✅ **Criar conta pelo Admin:** `/admin/subscriptions`
   - Email: `evsnutrivibe@gmail.com`
   - Nome: `Érika Cremmer`
   - Área: `wellness`
   - Dias: `365`
...
3. ✅ **Verificar:**
   - A query final mostra o resultado
   - Deve aparecer: `plan_type: annual`, `amount: 574.80`, `status: active`
