-- =====================================================
-- Migrar usuários do plano Coach para YLADA
-- =====================================================
-- Cria ylada_noel_profile (segment=ylada) para usuários
-- que têm perfil=coach em user_profiles.
-- Copia nome e whatsapp. NÃO preenche profile_type/profession
-- para que sejam redirecionados a preencher o perfil ao acessar.
