-- =====================================================
-- INSERIR CLIENTES FICTÍCIOS - VERSÃO SIMPLES
-- =====================================================
-- Este script primeiro mostra seu user_id disponível
-- Depois você pode executar a parte de inserção
-- =====================================================

-- =====================================================
-- PARTE 1: VERIFICAR SEU USER_ID
-- =====================================================
-- Execute esta parte primeiro para ver seu user_id
...
-- Se não aparecer nenhum resultado, você precisa fazer login primeiro na aplicação
-- Acesse: http://localhost:3000/pt/nutri/login

-- =====================================================
-- PARTE 2: INSERIR CLIENTES
-- =====================================================
...
BEGIN
  -- Pegar automaticamente o primeiro user_id de perfil nutri
  ...
  IF v_user_id IS NULL THEN
    RAISE EXCEPTION 'Nenhum usuário encontrado. Faça login primeiro na aplicação (/pt/nutri/login) para criar seu perfil.';
  END IF;
  ...
  INSERT INTO clients (user_id, name, email, phone, phone_country_code, birth_date, gender, status, goal, instagram, address_city, address_state, converted_from_lead, lead_source, client_since, created_at)
  VALUES (v_user_id, 'João Pedro Oliveira', 'joao.pedro@email.com', '5511988776655', 'BR', '1988-08-22', 'masculino', 'ativa', 'Ganhar 8kg de massa muscular', '@joaopedrofit', 'Rio de Janeiro', 'RJ', true, 'link-personalizado', NOW() - INTERVAL '2 months', NOW() - INTERVAL '2 months')
  ...
  VALUES (v_user_id, 'Ana Carolina Costa', 'ana.carolina@email.com', '5511977665544', 'BR', '1995-03-10', 'feminino', 'pre_consulta', 'Melhorar minha alimentação', 'Belo Horizonte', 'MG', true, 'quiz-saude', NOW() - INTERVAL '1 week', NOW() - INTERVAL '1 week')
  ...
  VALUES (v_user_id, 'Carlos Eduardo Lima', 'carlos.eduardo@email.com', '5511966554433', 'BR', '1992-11-30', 'masculino', 'lead', 'Quero emagrecer', 'Curitiba', 'PR', false, 'calculadora-imc', NOW() - INTERVAL '2 days')
  ...
  VALUES (v_user_id, 'Fernanda Alves', 'fernanda.alves@email.com', '5511955443322', 'BR', '1987-07-18', 'feminino', 'pausa', 'Manter o peso', '@fernandaalves', 'Porto Alegre', 'RS', NOW() - INTERVAL '6 months', NOW() - INTERVAL '6 months')
  ...
  VALUES (v_user_id, 'Roberto Santos', 'roberto.santos@email.com', '5511944332211', 'BR', '1985-04-25', 'masculino', 'finalizada', 'Alcançar objetivo', 'Salvador', 'BA', NOW() - INTERVAL '1 year', NOW() - INTERVAL '1 year')
