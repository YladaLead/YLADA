-- =====================================================
-- LIMPEZA TOTAL E INSERÇÃO DOS 3 TEMPLATES ESSENCIAIS
-- Data: 2025-12-18
-- =====================================================
-- Este script REMOVE TODOS os templates antigos
-- e insere apenas os 3 templates essenciais:
-- 1. Anamnese Nutricional Básica
-- 2. Recordatório Alimentar 24h
-- 3. Acompanhamento Semanal
-- =====================================================

-- ⚠️ ATENÇÃO: Este script vai DELETAR TODOS os templates existentes!
-- Se você tiver templates personalizados importantes, faça backup antes.

-- Passo 1: DELETAR TODOS OS TEMPLATES
DELETE FROM custom_forms 
WHERE is_template = true;

SELECT '✅ Todos os templates antigos foram removidos!' as status;
...
-- ✅ MIGRAÇÃO COMPLETA
SELECT '✅ Limpeza completa! Apenas 3 templates essenciais foram criados!' as status;
