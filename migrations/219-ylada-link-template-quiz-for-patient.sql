-- =====================================================
-- Template quiz: conteúdo padrão para o PACIENTE (quem acessa),
-- não sobre o negócio/agenda do profissional.
-- O profissional compartilha o link; o paciente vê tema que atrai e gera curiosidade.
-- @see feedback: "o link tem que ser sobre a especialidade do médico, algo que
-- atrai pacientes e desperta curiosidade nas pessoas comuns (possíveis pacientes)".
-- =====================================================

UPDATE ylada_link_templates
SET schema_json = '{
  "title": "Avaliação: um tema que importa para você",
  "questions": [
