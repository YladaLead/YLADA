-- =====================================================
-- CORREÇÃO DEFINITIVA: Templates Coach
-- Este script corrige TODOS os problemas identificados:
-- 1. Corrige os slugs dos 16 templates com slugs errados
-- 2. Desativa os templates extras que não estão na lista dos 29
...
-- =====================================================
-- PASSO 1: CORRIGIR SLUGS DOS TEMPLATES
-- =====================================================
...
-- =====================================================
-- PASSO 2: DESATIVAR TEMPLATES EXTRAS
-- =====================================================
...
SELECT 
  ...
  ) as templates_corretos_ativos,
  COUNT(*) FILTER (WHERE is_active = true 
    AND profession = 'coach' 
    AND language = 'pt'
  ) as total_templates_ativos,
  COUNT(*) FILTER (WHERE is_active = false 
    AND profession = 'coach' 
    AND language = 'pt'
  ) as templates_desativados
FROM coach_templates_nutrition;

-- =====================================================
-- PASSO 4: LISTAR OS 29 TEMPLATES CORRETOS
-- =====================================================
SELECT 
  name as nome,
  slug,
  type as tipo,
  '✅ ATIVO E CORRETO' as status
FROM coach_templates_nutrition
