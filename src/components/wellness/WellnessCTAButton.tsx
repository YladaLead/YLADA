        ...
        <div>
          {precisaColetarDados && !dadosEnviados ? (
            <button
              ...
              className="flex items-center gap-4 w-full py-4 px-5 rounded-xl transition-colors"
            ...
            >
              ...
              <div className="text-left">
                ...
                {botaoTexto && <p className="text-white/80 text-xs mt-0.5 leading-snug">{botaoTexto}</p>}
              </div>
            </button>
          ) : (
            <a
