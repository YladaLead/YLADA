    ...
    <>
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="bg-white rounded-xl p-4 border border-gray-200 text-center">
          ...
          <p className="text-xl font-bold text-gray-900">R$ 300 <span className="text-sm font-normal">/ mês</span></p>
        </div>
        <div className="relative bg-white rounded-xl p-4 border-2 border-blue-300 text-center bg-gradient-to-br from-blue-50/50 to-indigo-50/50">
          ...
          <p className="text-xl font-bold text-gray-900">12x de R$ 150</p>
