                      ...
                      <>
                        <div className="mt-3 flex flex-wrap gap-2">
                          ...
                          {conducaoUiEnabled && quizUrl ? (
                            // Requisito 3 do Contrato_Link_Real_Loop_Ready: compartilhar em 1 toque
                            // (tira o atrito entre "link criado" e "link na mão de alguém" → efetiva a ativação/loop).
                            <a
                              href={`https://wa.me/?text=${encodeURIComponent(
                                `Preparei um diagnóstico rápido que pode te ajudar. É leve, leva uns 2 minutinhos: ${quizUrl}`
                              )}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-green-600 text-white text-sm font-medium hover:bg-green-700 transition-colors touch-manipulation"
                            >
