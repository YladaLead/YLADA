...
const CORES_PROPOSITO = ['purple', 'indigo', 'purple', 'indigo', 'purple'] as const
      ...
      <div className="relative">
        ...
        {etapa === 0 && (
          <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-6 rounded-lg border-2 border-purple-200">
            ...
            <p className="text-purple-600 font-semibold">🚀 Entrada temática Propósito — mesmas 5 perguntas do núcleo Ganhos no link Pro Líderes.</p>
