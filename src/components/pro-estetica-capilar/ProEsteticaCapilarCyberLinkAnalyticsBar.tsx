...
const LINKS_HUB = `${PRO_ESTETICA_CAPILAR_BASE_PATH}/biblioteca-links?tab=meus`
...
export default function ProEsteticaCapilarCyberLinkAnalyticsBar({
  previewWithoutLogin,
}: {
  ...
  const load = useCallback(async () => {
    ...
    setError(null)
    try {
      const res = await fetch('/api/pro-estetica-capilar/links-analytics-summary', {
        credentials: 'include',
        cache: 'no-store',
      })
