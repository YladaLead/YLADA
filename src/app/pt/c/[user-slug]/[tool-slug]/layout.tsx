...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    ...
    if (!tool) {
      ...
      return {
        ...
        openGraph: {
          title: `${fallbackTitle} - COACH`,
          description: fallbackDescription,
          url: `${baseUrl}/pt/c/${userSlug}/${toolSlug}`,
    ...
    console.log('[OG Metadata] Image URL (Coach - /pt/c/):', {
      normalizedSlug,
      ogImageUrl,
      absoluteImageUrl,
      baseUrl,
    ...
    const pageUrl = `${baseUrl}/pt/c/${userSlug}/${toolSlug}`
    ...
    // Fallback para metadata padrão
    const pageUrl = `${fallbackBaseUrl}/pt/c/${userSlug}/${toolSlug}`
    return {
