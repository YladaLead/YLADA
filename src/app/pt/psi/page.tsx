  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link href="/pt" className="flex items-center gap-2">
              ...
              <span className="text-gray-500 text-sm">· Psicologia</span>
            </Link>
      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-lg text-gray-700 mb-6 text-center">
                A pessoa responde uma avaliação rápida antes da conversa. Assim você entende interesses, necessidades e o momento da pessoa.
              </p>
        ...
        {/* 🔟 PREÇO — mesma seção da página de preços; clique leva direto ao pagamento */}
        <section className="py-12 sm:py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
