...
export default function VendasPaulaPage() {
  ...
  const handleCheckout = (planType: 'annual' | 'monthly') => {
    const checkoutUrl = `/pt/nutri/checkout?plan=${planType}&ref=paula`
    ...
    <div className="min-h-screen bg-white relative">
      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center pt-3 sm:pt-4">
                ...
                <Link
                  href="/pt/nutri/checkout?plan=annual&ref=paula"
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                {[
                  { title: '1. Captação Previsível', desc: 'Você para de depender de indicação ou sorte. Sistema de captação que funciona de forma consistente.' },
                  { title: '2. Trilha empresarial clara', desc: 'Próximo passo definido. Você executa com método, não na base do improviso. Sem "gestão de clientes" pesada; apenas controle claro de leads e conversão.' },
                  { title: '3. LYA como mentoria estratégica', desc: 'Orientações que impedem abandono e travas. Você não fica sozinha.' }
                ].map((item, index) => (
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-[#FF4F4F]/10 rounded-xl p-8 border-2 border-[#FF4F4F]">
                  ...
                  <ul className="space-y-3 text-lg text-gray-700">
                    <li className="flex items-start"><span className="text-[#FF4F4F] mr-3 text-xl font-bold">✗</span><span>Acordava ansiosa, sem saber se teria clientes</span></li>
                    <li className="flex items-start"><span className="text-[#FF4F4F] mr-3 text-xl font-bold">✗</span><span>Sentia vergonha quando não sabia quanto cobrar</span></li>
                    <li className="flex items-start"><span className="text-[#FF4F4F] mr-3 text-xl font-bold">✗</span><span>Se sentia sozinha, sem ninguém para ajudar</span></li>
                    <li className="flex items-start"><span className="text-[#FF4F4F] mr-3 text-xl font-bold">✗</span><span>Dormia frustrada, pensando que nunca ia dar certo</span></li>
                    <li className="flex items-start"><span className="text-[#FF4F4F] mr-3 text-xl font-bold">✗</span><span>Trabalhava na base do improviso</span></li>
                  </ul>
                </div>
                <div className="bg-[#29CC6A]/10 rounded-xl p-8 border-2 border-[#29CC6A]">
                  ...
                  <ul className="space-y-3 text-lg text-gray-700">
                    <li className="flex items-start"><span className="text-[#29CC6A] mr-3 text-xl font-bold">✓</span><span>Acorda tranquila, com sistema de captação funcionando</span></li>
                    <li className="flex items-start"><span className="text-[#29CC6A] mr-3 text-xl font-bold">✓</span><span>Se sente confiante para cobrar</span></li>
                    <li className="flex items-start"><span className="text-[#29CC6A] mr-3 text-xl font-bold">✓</span><span>Tem mentoria e estrutura, não está sozinha</span></li>
                    <li className="flex items-start"><span className="text-[#29CC6A] mr-3 text-xl font-bold">✓</span><span>Trabalha com método, não na base do improviso</span></li>
                  </ul>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  { title: 'Captação Automática', paraDe: 'depender de indicação', resultado: 'Captação que funciona sem postar e torcer.' },
                  { title: 'Organização Total', paraDe: 'trabalhar no improviso', resultado: 'Rotina e captação claras: o que fazer hoje, o que converter.' },
                  { title: 'Clareza Empresarial', paraDe: 'tentar sem método', resultado: 'Trilha Empresarial (30 dias) com passo a passo.' },
                  { title: 'Comunidade', paraDe: 'se sentir sozinha', resultado: 'Nutri-Empresárias crescendo juntas e com suporte.' },
                  { title: 'Suporte Humano', paraDe: 'ficar só na tecnologia', resultado: 'LYA + suporte humano quando precisar.' }
                ].map((item, index) => (
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white rounded-xl p-6 border-2 border-[#FF9800] text-center">
                  ...
                  <p className="text-lg font-bold text-gray-700">Cada mês sem método = mais frustração acumulada</p>
                </div>
                <div className="bg-white rounded-xl p-6 border-2 border-[#FF4F4F] text-center">
                  <div className="text-4xl mb-4">💸</div>
                  <p className="text-lg font-bold text-gray-700">Cada cliente que você perde por falta de organização = dinheiro que não volta</p>
                </div>
                <div className="bg-white rounded-xl p-6 border-2 border-[#2563EB] text-center">
                  <div className="text-4xl mb-4">⏰</div>
                  <p className="text-lg font-bold text-gray-700">Cada dia que você adia = mais tempo longe da carreira que você quer ter</p>
                </div>
              </div>
              <div className="space-y-6">
                <div className="bg-[#FFF4E6] rounded-xl p-6 border-2 border-[#FF9800]">
                  ...
                  <p className="text-lg font-semibold text-gray-700">O custo não é só financeiro. É emocional.</p>
                </div>
        ...
        <section className="py-12 sm:py-16 bg-[#F5F7FA]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#1A1A1A] mb-6">O que custa não decidir?</h2>
              <p className="text-lg text-gray-700 mb-4">Agenda vazia, insegurança constante, dependência de terceiros.</p>
              <p className="text-xl font-bold text-[#2563EB]">O próximo passo é seu.</p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-2xl border-4 border-yellow-400 relative" style={{ pointerEvents: 'auto' }}>
                ...
                <ul className="space-y-3 mb-6 text-gray-700">
                  <li className="flex items-start"><span className="text-[#29CC6A] mr-3 text-xl">✓</span><span>Sistema de captação com orientação LYA (você não trava)</span></li>
                  <li className="flex items-start"><span className="text-[#29CC6A] mr-3 text-xl">✓</span><span>Links inteligentes e rotina que gera agenda</span></li>
                  <li className="flex items-start"><span className="text-[#29CC6A] mr-3 text-xl">✓</span><span>Metodologia clara para encher agenda e parar de agendar ansiosa</span></li>
                  <li className="flex items-start"><span className="text-[#29CC6A] mr-3 text-xl">✓</span><span>7 dias de garantia incondicional</span></li>
                </ul>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { pergunta: 'Como funciona o suporte?', resposta: 'Você tem acesso a: LYA (mentora estratégica digital), disponível 24/7 para orientações estratégicas. Suporte técnico, para dúvidas sobre uso da plataforma. Comunidade, para trocar experiências com outras Nutri-Empresárias.' },
                  ...
                  { pergunta: 'E se eu não conseguir usar tudo? Vou ter desperdiçado meu dinheiro?', resposta: 'Você não precisa usar tudo. O YLADA não é sobre usar todas as ferramentas. É sobre usar as ferramentas certas, no momento certo. A LYA te ajuda a focar no que é prioritário para o seu momento atual. Você não precisa descobrir sozinha. E com a garantia de 7 dias, você pode testar sem risco.' },
                  { pergunta: 'E se eu não tiver tempo para isso?', resposta: 'O YLADA foi feito para economizar seu tempo, não para consumir. A ideia é você trabalhar menos e ganhar mais. A LYA te guia para focar no que realmente importa, sem perder tempo com o que não faz diferença agora. O método foi pensado para nutricionistas que já têm uma rotina corrida.' }
                ].map((item, index) => (
      ...
      <footer className="border-t border-gray-200 bg-white mt-16">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col items-center justify-center">
            <div className="mb-4">
              <Image src="/images/logo/nutri-horizontal.png" alt="YLADA Nutri" width={133} height={40} className="h-8 w-auto" />
            </div>
            <p className="text-gray-600 text-sm mb-2 text-center">YLADA Nutricionista: Your Leading Advanced Data Assistant</p>
            <p className="text-gray-500 text-xs text-center mb-2">© {new Date().getFullYear()} YLADA. Todos os direitos reservados.</p>
            <p className="text-gray-400 text-xs text-center">Portal Solutions Tech & Innovation LTDA</p>
            <p className="text-gray-400 text-xs text-center">CNPJ: 63.447.492/0001-88</p>
          </div>
        </div>
      </footer>
    </div>
