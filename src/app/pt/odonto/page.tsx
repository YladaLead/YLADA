...
/**
 * Landing YLADA para Odontologia — template oficial.
 */
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link href="/pt" className="flex items-center gap-2">
              ...
              <span className="text-gray-500 text-sm">· Odontologia</span>
            </Link>
      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-4">
                YLADA para Odontologia
              </h1>
              <p className="text-lg sm:text-xl text-gray-700 mb-4">
                Mostrar o valor dos tratamentos antes da avaliação.
              </p>
              <p className="text-base sm:text-lg text-gray-600 mb-6">
                O paciente responde uma avaliação rápida antes do contato. Assim você entende necessidades, preocupações e o momento ideal para cada tratamento antes mesmo da primeira consulta.
              </p>
        ...
        <HeroBeforeAfter area="odonto" />

        <section className="py-12 sm:py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 text-center">
                Dentistas enfrentam três dificuldades comuns no marketing online
              </h2>
              <ul className="space-y-4 text-gray-700">
                <li className="flex items-start gap-3">
                  <span className="text-red-500 font-bold shrink-0">•</span>
                  <span>Pacientes pedindo orçamento sem entender o valor do tratamento</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-red-500 font-bold shrink-0">•</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-red-500 font-bold shrink-0">•</span>
                  <span>Dificuldade de mostrar o valor antes da avaliação presencial</span>
                </li>
              </ul>
              <p className="text-center text-gray-600 mt-8 font-medium">
                Isso consome tempo, gera conversas improdutivas e reduz a conversão em consultas.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 sm:py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 text-center">
                O YLADA ajuda você a mostrar o valor antes da avaliação
              </h2>
              <p className="text-lg text-gray-700 mb-6 text-center">
                O paciente responde uma avaliação rápida antes do contato. Assim você entende necessidades e pode orientar sobre tratamentos antes mesmo da consulta.
              </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  { step: '1', title: 'Escolha uma avaliação', desc: 'Quizzes e diagnósticos prontos para odontologia.' },
                  { step: '2', title: 'Compartilhe o link', desc: 'Use em redes sociais, WhatsApp ou site.' },
                  { step: '3', title: 'O paciente responde', desc: 'O sistema identifica necessidades e preocupações.' },
                  { step: '4', title: 'Avaliação com contexto', desc: 'Você atende pacientes que já entendem o valor do tratamento.' },
                ].map((item) => (
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-start">
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-gray-400 font-mono">ylada.app/avaliacao/saude-bucal</p>
                  <div className="bg-white rounded-2xl p-5 shadow-lg border border-gray-100 max-w-sm">
                    <p className="text-xs text-gray-500 mb-2">Avaliação: &quot;Sua saúde bucal pode precisar de atenção?&quot;</p>
                    <div className="bg-blue-50 rounded-xl p-4 border-l-4 border-blue-500">
                      <p className="font-semibold text-gray-900 mb-2">Resultado do diagnóstico</p>
                      <p className="font-medium text-gray-800 mb-2">Perfil identificado: Sinais de atenção preventiva</p>
                      <p className="text-sm text-gray-600 mb-3">Possíveis sinais:</p>
                      <ul className="text-sm text-gray-700 space-y-1">
                        <li>• sensibilidade ao frio ou calor</li>
                        <li>• sangramento na escovação</li>
                        <li>• interesse em prevenção</li>
                      </ul>
                    </div>
                    <p className="text-xs text-gray-500 mt-3 italic">
                      Esse resultado sugere que uma avaliação odontológica pode ajudar.
                    </p>
                  ...
                  <div className="bg-[#dcf8c6] rounded-xl p-4 max-w-sm ml-4 border border-gray-200">
                    <p className="text-sm text-gray-800">
                      &quot;Gostaria de agendar uma avaliação. Quais tratamentos vocês oferecem?&quot;
                    </p>
              ...
              <p className="text-gray-700 text-center mt-8 max-w-2xl mx-auto">
                Quando o paciente responde uma avaliação, ele começa a refletir sobre sua saúde bucal. Isso gera interesse e abertura para agendar uma consulta.
              </p>
        ...
        <section className="py-12 sm:py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 text-center">
                Avaliações usadas por dentistas
              </h2>
              <p className="text-gray-700 mb-6 text-center">
                Dentistas usam avaliações como:
              </p>
              <ul className="space-y-3 text-gray-700 mb-6">
                {[
                  'Sua saúde bucal pode precisar de atenção?',
                  'Você pode estar adiando tratamentos importantes?',
                  'Seus dentes podem estar precisando de cuidados preventivos?',
                ].map((item) => (
              ...
              <p className="text-gray-600 text-center text-sm">
                Essas avaliações ajudam a mostrar o valor dos tratamentos antes da consulta.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  'Pacientes que entendem o valor do tratamento',
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <blockquote className="mt-3 text-gray-800 italic border-l-4 border-blue-500 pl-4 py-2 bg-blue-50/50 rounded-r-lg">
                &quot;Vi que você respondeu a avaliação sobre saúde bucal. Quer agendar uma avaliação para conversarmos sobre os tratamentos?&quot;
              </blockquote>
            </div>
          </div>
        </section>
