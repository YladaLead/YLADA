...
const EXEMPLOS_ODONTO = [
  { titulo: 'Sua saúde bucal pode precisar de atenção?', href: DIAG_BASE },
  { titulo: 'Descubra o que seu sorriso precisa', href: DIAG_BASE },
  { titulo: 'Você sente dor ou desconforto?', href: DIAG_BASE },
  { titulo: 'Você está pronto para avaliar?', href: DIAG_BASE },
]

const HOW_IT_WORKS_ODONTO = [
  { title: 'Criar diagnóstico', desc: 'Transforme seu conhecimento em perguntas que revelam necessidades e conscientização do paciente.' },
  ...
  { title: 'Consulta com contexto', desc: 'O paciente chega mais consciente e a consulta avança com mais facilidade.' },
]

export default function OdontoInstitutionalContent() {
  ...
  useEffect(() => {
    if (loading || !isOdontoPage) return
    if (user) {
      router.replace('/pt/odonto/home')
    }
  }, [loading, user, pathname, router, isOdontoPage])

  const showAuthLoading = loading && isOdontoPage && !authTimeout
  if (showAuthLoading) {
    return (
  ...
  return (
    <div className="min-h-screen bg-white">
      <header className="sticky top-0 z-50 border-b border-gray-200 bg-white shadow-sm h-[72px] flex items-center safe-area-inset-top">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-full">
          <Link href="/pt" className="flex items-center gap-2 flex-shrink-0 touch-manipulation" aria-label="YLADA início">
            ...
            <span className="text-gray-500 text-sm font-medium hidden sm:inline">· Odontologia</span>
          </Link>
          <nav className="flex items-center gap-3 sm:gap-6">
            ...
            <Link href="/pt/odonto/login" className="text-gray-600 hover:text-gray-900 text-sm font-medium">
              Entrar
            </Link>
            <Link
              href="/pt/cadastro?area=odonto"
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-2xl mx-auto px-1">
            <h1 className="text-center mb-8">
              <span className="block text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight mb-2">
                Pessoas perguntam preço e somem?
              </span>
            ...
            <div id="quiz-diagnostico" className="max-w-xl mx-auto mb-8 rounded-2xl bg-white border-2 border-gray-200 shadow-lg shadow-gray-200/50 scroll-mt-8 overflow-hidden">
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="space-y-2 mb-6">
                  {[
                    { label: 'Pessoas que perguntam preço e somem', value: 0 },
                    { label: 'Pacientes que não agendam avaliação', value: 1 },
                    { label: 'Pacientes realmente preparados para consulta', value: 2 },
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (respostaHeroIdx !== null) {
                        ...
                        router.push(`/pt/diagnostico?fromHome=1&area=6&fromArea=odonto&problema=${problemaValue}`)
                      }
                    }}
        ...
        <DemoCarouselYLADA initialArea="odonto" />
        ...
        <section className="bg-gray-50 py-12 sm:py-16 lg:py-20 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-xl sm:text-3xl font-bold text-gray-900 mb-6 sm:mb-8 text-center">
              A maioria dos dentistas fala de preço antes de valor.
            </h2>
            <ul className="space-y-3 text-gray-700 mb-6">
              <li className="flex items-start gap-3">
                <span className="text-red-500 mt-1">•</span>
                <span>Pessoas perguntam preço e somem</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-red-500 mt-1">•</span>
                <span>Pacientes que não agendam avaliação</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-red-500 mt-1">•</span>
                <span>Falta de clareza sobre o valor do tratamento</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-red-500 mt-1">•</span>
            ...
            <p className="text-lg font-semibold text-gray-900 text-center mb-8">
              O problema raramente é seu preço.<br />
              É a forma como o paciente entende a própria necessidade antes da conversa.
            </p>
            <p className="text-gray-500 text-sm text-center">
              Quando o paciente responde perguntas sobre sintomas, desconforto ou prevenção, ele começa a valorizar a avaliação antes de perguntar preço.
            </p>
          </div>
        </section>
        ...
        <section className="py-10 sm:py-14 bg-white border-b border-gray-100">
          <div className="max-w-2xl mx-auto text-center px-4">
            <div className="bg-gray-900 text-white rounded-2xl p-8 sm:p-10">
              <p className="text-base sm:text-lg text-gray-300 mb-3">Falar de preço primeiro não traz pacientes.</p>
              <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-white leading-tight">
                Boas consultas começam com boas perguntas.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-4">
            <div className="rounded-2xl overflow-hidden border border-gray-200 shadow-lg bg-gray-50/50">
              <Image
                ...
                alt="Comparação: Funil tradicional vs Funil de diagnóstico YLADA. Boas consultas começam com boas perguntas."
                width={900}
                height={600}
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-white">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto px-4">
            {HOW_IT_WORKS_ODONTO.map((item, i) => (
        ...
        <section className="bg-gray-50 py-10 sm:py-14 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
          <div className="max-w-xl mx-auto text-center">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              Quando uma pessoa responde perguntas sobre dor, desconforto ou prevenção bucal, ela começa a entender a própria necessidade antes da conversa.
            </p>
            ...
            <p className="text-lg font-semibold text-gray-900 mt-6">
              Quando o paciente entende o valor da avaliação, a consulta acontece.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 sm:py-16 lg:py-20">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-xl sm:text-3xl font-bold text-gray-900 text-center mb-4">
              Exemplos de diagnósticos para dentistas
            </h2>
            <div className="grid sm:grid-cols-2 gap-4 mb-6">
              {EXEMPLOS_ODONTO.map((ex, i) => (
                <Link
                  key={i}
                  href={ex.href}
            ...
            <p className="text-center text-gray-600 text-sm">
              Esses são exemplos de diagnósticos que dentistas podem criar com YLADA.
            </p>
          </div>
        </section>
        ...
        <section className="bg-gray-50 py-12 sm:py-16 lg:py-20 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">
              Dentistas usam diagnósticos para:
            </h2>
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-center justify-center gap-2">
                <span className="text-green-600">✔</span>
                <span>atrair pacientes mais preparados para avaliação</span>
              </li>
              <li className="flex items-center justify-center gap-2">
                <span className="text-green-600">✔</span>
                <span>reduzir conversas que só perguntam preço e somem</span>
              </li>
              <li className="flex items-center justify-center gap-2">
                <span className="text-green-600">✔</span>
                <span>explicar valor do tratamento com mais facilidade</span>
              </li>
              <li className="flex items-center justify-center gap-2">
                <span className="text-green-600">✔</span>
        ...
        <YladaProfissionaisGridSection locale={locale} highlightCodigo="odonto" />
        ...
        <section className="bg-sky-50 py-12 sm:py-16 border-y border-sky-100">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-6">Comece grátis e teste com pacientes reais.</p>
            <Link
              href="/pt/cadastro?area=odonto"
        ...
        <section className="bg-[#1e3a8a] py-16 sm:py-20 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-white/90 text-base sm:text-lg mb-8 max-w-xl mx-auto">
              Em vez de falar de preço primeiro, deixe o paciente chegar já entendendo a própria necessidade — e agende com mais facilidade.
            </p>
            <Link
              href="/pt/cadastro?area=odonto"
        ...
        <div className="w-full max-w-7xl mx-auto px-4 py-8 sm:py-10">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <nav className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 mb-6 text-sm">
              ...
              <Link href="/pt/odonto/login" className="text-gray-600 hover:text-gray-900">Entrar</Link>
              <Link href="/pt/cadastro?area=odonto" className="text-blue-600 hover:text-blue-700 font-medium">Criar diagnóstico</Link>
            </nav>
