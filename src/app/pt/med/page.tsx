...
/**
 * Landing YLADA para Médicos — template oficial.
 * Fluxo: institucional → /pt/med → CTA Começar → /pt/precos → checkout
 */
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link href="/pt" className="flex items-center gap-2">
              ...
              <span className="text-gray-500 text-sm">· Medicina</span>
            </Link>
      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-lg sm:text-xl text-gray-700 mb-2">
                Transforme curiosos em consultas com contexto.
              </p>
              <p className="text-base sm:text-lg text-gray-600 mb-4">
                Entenda sintomas e preocupações antes mesmo do primeiro contato.
              </p>
              <p className="text-base sm:text-lg text-gray-600 mb-6">
                O paciente responde uma avaliação rápida antes do contato. Assim você entende sintomas, preocupações e o momento da pessoa antes mesmo da primeira conversa.
              </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 text-center">
                Médicos enfrentam três dificuldades comuns no marketing online
              </h2>
              <ul className="space-y-4 text-gray-700">
                <li className="flex items-start gap-3">
                  <span className="text-red-500 font-bold shrink-0">•</span>
                  <span>Pacientes pedindo orientação sem consulta</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-red-500 font-bold shrink-0">•</span>
                  <span>Conversas que começam e não evoluem</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-red-500 font-bold shrink-0">•</span>
                  <span>Falta de contexto no primeiro contato</span>
                </li>
              </ul>
        ...
        <section className="py-12 sm:py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 text-center">
                O YLADA ajuda você a iniciar consultas com contexto
              </h2>
              <p className="text-lg text-gray-700 mb-6 text-center">
                O paciente responde uma avaliação rápida antes do contato. Assim você entende sintomas, preocupações e o momento da pessoa.
              </p>
              <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                <p className="text-gray-700 text-center">
                  Atrair pacientes que já entendem o valor da consulta.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  { step: '1', title: 'Escolha uma avaliação', desc: 'Quizzes e diagnósticos prontos para medicina.' },
                  { step: '2', title: 'Compartilhe o link', desc: 'Use em redes sociais, WhatsApp ou site.' },
                  { step: '3', title: 'O paciente responde', desc: 'O sistema identifica sintomas, preocupações e o momento da pessoa.' },
                  { step: '4', title: 'Consulta com contexto', desc: 'Você atende pacientes que realmente precisam de avaliação.' },
                ].map((item) => (
        ...
        {/* 5️⃣ VEJA COMO FUNCIONA NA PRÁTICA */}
        <section className="py-12 sm:py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-start">
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-gray-400 font-mono">ylada.app/avaliacao/estresse</p>
                  <div className="bg-white rounded-2xl p-5 shadow-lg border border-gray-100 max-w-sm">
                    <p className="text-xs text-gray-500 mb-2">Avaliação: &quot;Seus sintomas podem estar relacionados ao estresse?&quot;</p>
                    <div className="bg-blue-50 rounded-xl p-4 border-l-4 border-blue-500">
                      <p className="font-semibold text-gray-900 mb-2">Resultado do diagnóstico</p>
                      <p className="font-medium text-gray-800 mb-2">Perfil identificado: Sobrecarga física moderada</p>
                      <p className="text-sm text-gray-600 mb-3">Possíveis sinais:</p>
                      <ul className="text-sm text-gray-700 space-y-1">
                        <li>• cansaço persistente</li>
                        <li>• dificuldade para recuperar energia</li>
                        <li>• corpo sobrecarregado</li>
                      </ul>
                    </div>
                    <p className="text-xs text-gray-500 mt-3 italic">
                      Esse resultado sugere que uma avaliação médica pode ajudar a entender melhor esses sinais.
                    </p>
                  ...
                  <div className="bg-[#dcf8c6] rounded-xl p-4 max-w-sm ml-4 border border-gray-200">
                    <p className="text-sm text-gray-800">
                      &quot;Achei interessante esse resultado. Como posso agendar uma consulta?&quot;
                    </p>
                  ...
                  <div className="aspect-video bg-gray-200 rounded-xl flex items-center justify-center border-2 border-dashed border-gray-300">
                    <div className="text-center p-6">
                      ...
                      <p className="text-gray-400 text-xs max-w-[200px] mx-auto">
                        Vídeo curto (30–40s) mostrando: criar avaliação → enviar link → paciente responde → diagnóstico aparece → consulta começa
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <p className="text-gray-700 text-center mt-8 max-w-2xl mx-auto">
                Quando o paciente responde uma avaliação, ele começa a refletir sobre sua própria situação. Isso gera curiosidade, interesse e abertura para agendar uma consulta.
              </p>
              <p className="text-gray-800 font-medium text-center mt-4">
                O objetivo não é convencer curiosos.
                <br />
                É atrair pacientes que já entendem o valor da consulta.
              </p>
        ...
        <section className="py-12 sm:py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 text-center">
                Avaliações usadas por médicos
              </h2>
              <p className="text-gray-700 mb-6 text-center">
                Médicos usam avaliações como:
              </p>
              <ul className="space-y-3 text-gray-700 mb-6">
                {[
                  'Seus sintomas podem estar relacionados ao estresse?',
                  'Seu nível de energia pode estar baixo?',
                  'Seu corpo pode estar sobrecarregado?',
                ].map((item) => (
              ...
              <p className="text-gray-600 text-center text-sm">
                Essas avaliações ajudam a iniciar conversas mais relevantes e qualificadas.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* 7b. Casos de uso */}
        <UseCasesSection area="med" />

        {/* 8️⃣ EXEMPLO DE CONVERSA */}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <blockquote className="mt-3 text-gray-800 italic border-l-4 border-blue-500 pl-4 py-2 bg-blue-50/50 rounded-r-lg">
                &quot;Vi que você respondeu a avaliação sobre estresse. Quer agendar uma consulta para avaliarmos melhor?&quot;
              </blockquote>
            </div>
          </div>
        </section>
