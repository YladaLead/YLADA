            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="space-y-6 lg:space-y-7">
                <p className="text-lg lg:text-xl text-gray-600 leading-relaxed lg:leading-relaxed">
                  YLADA significa <span className="font-semibold text-gray-900 whitespace-nowrap">Your Lead Advanced Data Assistant</span> — o seu assistente avançado para <span className="whitespace-nowrap">gerar conexões significativas.</span>
                </p>
