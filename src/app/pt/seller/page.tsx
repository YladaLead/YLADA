      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-4">
                YLADA para Vendedores
              </h1>
              <p className="text-lg sm:text-xl text-gray-700 mb-4">
                Iniciar conversas com clientes mais qualificados.
              </p>
              <p className="text-base sm:text-lg text-gray-600 mb-6">
                O cliente responde uma avaliação rápida antes do contato. Assim você entende necessidades, interesses e o momento de compra antes mesmo da primeira conversa.
              </p>
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <ul className="space-y-4 text-gray-700">
                <li className="flex items-start gap-3">
                  ...
                  <span>Leads frios que não evoluem para conversa</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-red-500 font-bold shrink-0">•</span>
                  <span>Conversas que começam e não evoluem para venda</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-red-500 font-bold shrink-0">•</span>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-start">
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-gray-400 font-mono">ylada.app/avaliacao/necessidade</p>
                  <div className="bg-white rounded-2xl p-5 shadow-lg border border-gray-100 max-w-sm">
                    <p className="text-xs text-gray-500 mb-2">Avaliação: &quot;Qual solução pode atender sua necessidade?&quot;</p>
                    <div className="bg-blue-50 rounded-xl p-4 border-l-4 border-blue-500">
                      <p className="font-semibold text-gray-900 mb-2">Resultado do diagnóstico</p>
                      <p className="font-medium text-gray-800 mb-2">Perfil identificado: Interesse em solução personalizada</p>
                      <p className="text-sm text-gray-600 mb-3">Possíveis sinais:</p>
                      <ul className="text-sm text-gray-700 space-y-1">
                        <li>• necessidade específica identificada</li>
                        <li>• momento de decisão próximo</li>
                        <li>• interesse em conhecer opções</li>
                      </ul>
                    </div>
                    <p className="text-xs text-gray-500 mt-3 italic">
                      Esse resultado sugere que uma conversa pode ajudar a encontrar a solução ideal.
                    </p>
                  ...
                  <div className="bg-[#dcf8c6] rounded-xl p-4 max-w-sm ml-4 border border-gray-200">
                    <p className="text-sm text-gray-800">
                      &quot;Gostaria de saber mais sobre as opções. Podemos conversar?&quot;
                    </p>
              ...
              <p className="text-gray-700 text-center mt-8 max-w-2xl mx-auto">
                Quando o cliente responde uma avaliação, ele começa a refletir sobre sua necessidade. Isso gera interesse e abertura para iniciar uma conversa qualificada.
              </p>
        ...
        <section className="py-12 sm:py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 text-center">
                Avaliações usadas por vendedores
              </h2>
              <p className="text-gray-700 mb-6 text-center">
                Vendedores usam avaliações como:
              </p>
              <ul className="space-y-3 text-gray-700 mb-6">
                {[
                  'Qual solução pode atender sua necessidade?',
                  'Você está no momento certo para investir?',
                  'Seu perfil combina com qual tipo de oferta?',
                ].map((item) => (
              ...
              <p className="text-gray-600 text-center text-sm">
                Essas avaliações ajudam a qualificar leads e iniciar conversas mais produtivas.
              </p>
            </div>
          </div>
        </section>
