...
/**
 * Página de perfumaria: mesma estrutura e seções da home e da estética,
 * com conteúdo 100% focado em consultores de fragrância (dor não converte, fluxo sem perguntar área, vídeo perfumaria).
 */
...
export default function PerfumariaInstitutionalContent() {
  ...
  const isPerfumariaPage = /^\/pt\/perfumaria\/?(\?|$)/.test(pathname)
        ...
        <div className="w-full max-w-7xl mx-auto px-4 py-8 sm:py-10">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <nav className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 mb-6 text-sm">
              ...
              <Link href="/pt/perfumaria/login" className="text-blue-600 hover:text-blue-700 font-medium">Criar diagnóstico</Link>
            </nav>
