...
import WellnessSuporteBusca from '@/components/wellness/WellnessSuporteBusca'
...
export default function WellnessSuportePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl shadow-lg p-8 text-white">
          ...
          <p className="mb-6 opacity-90">
            Nossa equipe está pronta para te atender. Entre em contato pelo WhatsApp:
          </p>
          <div className="flex justify-center">
            <a
              ...
              className="bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-lg p-6 transition-all transform hover:scale-105"
            >
      ...
      {/* Chat Widget Flutuante - Noel como padrão na página de suporte */}
