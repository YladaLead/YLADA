...
export default function AvaliacaoIntolerancia({ config }: TemplateBaseProps) {
  ...
  const calcularResultado = (resps: number[]) => {
    ...
    const diagnostico = getDiagnostico('avaliacao-intolerancia', 'wellness', diagnosticoId)
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        {etapa === 'landing' && (
          <WellnessLanding
            ...
            benefits={[
              'Identifique possíveis intolerâncias alimentares',
              'Descubra alimentos que causam desconforto',
              'Receba orientações personalizadas',
              'Tenha acesso a produtos adequados ao seu perfil',
              'Melhore sua qualidade de vida e bem-estar'
            ]}
            onStart={iniciarQuiz}
