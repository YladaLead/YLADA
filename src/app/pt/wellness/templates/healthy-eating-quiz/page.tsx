...
export default function QuizAlimentacaoSaudavel({ config }: TemplateBaseProps) {
  ...
  const perguntas: Pergunta[] = [
    {
      id: 1,
      pergunta: 'Você sente que precisa melhorar seus hábitos alimentares?',
      tipo: 'multipla',
      opcoes: [
  ...
  const calcularResultado = (resps: number[]) => {
    ...
    let perfil = 'AlimentacaoPrecisaMelhorar'
    let descricao = ''
    let cor = 'red'
    let recomendacoes: string[] = []
    let diagnosticoId = 'alimentacaoPrecisaMelhorar'

    if (pontuacaoTotal >= 12) {
      perfil = 'Alimentação Precisa Melhorar - Necessita Atenção'
      descricao = 'Seu perfil indica que sua alimentação precisa de melhorias significativas. Um acompanhamento especializado pode ajudar a transformar seus hábitos alimentares e melhorar sua saúde.'
      cor = 'red'
      recomendacoes = [
        'Buscar avaliação profissional para melhorar alimentação',
        'Criar um plano alimentar saudável personalizado',
        'Utilizar produtos de qualidade que complementam alimentação',
        'Ter acompanhamento para monitorar progresso',
        'Aprender estratégias para manter alimentação saudável'
      ]
      diagnosticoId = 'alimentacaoPrecisaMelhorar'
    } else if (pontuacaoTotal >= 8) {
      perfil = 'Alimentação Moderada - Otimização Necessária'
      descricao = 'Você tem uma base alimentar, mas pode ser otimizada. Um acompanhamento pode ajudar a melhorar seus hábitos e criar uma alimentação mais saudável e equilibrada.'
      cor = 'yellow'
      recomendacoes = [
        'Investir em avaliação personalizada',
        'Ter um plano de otimização alimentar',
        'Utilizar produtos que complementam alimentação saudável',
        'Acompanhar progresso com suporte profissional',
        'Aprender a otimizar seus hábitos alimentares'
      ]
      diagnosticoId = 'alimentacaoModerada'
    } else {
      perfil = 'Alimentação Saudável - Manutenção Preventiva'
      descricao = 'Você já tem bons hábitos alimentares! Mesmo assim, um acompanhamento preventivo pode ajudar a manter essa qualidade e otimizar ainda mais sua alimentação.'
      cor = 'green'
      recomendacoes = [
        'Manter boa alimentação com estratégias preventivas',
        'Otimizar ainda mais com plano personalizado',
        'Utilizar produtos que mantêm qualidade alimentar',
        'Ter acompanhamento preventivo',
        'Aprender estratégias avançadas de alimentação saudável'
      ]
      diagnosticoId = 'alimentacaoSaudavel'
    }

    const diagnostico = alimentacaoSaudavelDiagnosticos.wellness[diagnosticoId as keyof typeof alimentacaoSaudavelDiagnosticos.wellness]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50">
      <WellnessHeader
        ...
        defaultDescription="Descubra como está sua alimentação e como melhorá-la"
      />
              ...
              <div className="space-y-3">
                {perguntas[perguntaAtual].opcoes.map((opcao, index) => (
                  <button
                    ...
                    className="w-full text-left p-4 bg-gray-50 rounded-lg border-2 border-gray-200 hover:border-emerald-300 hover:bg-emerald-50 transition-all transform hover:scale-[1.02]"
                  >
          ...
          <div className="space-y-6">
            <div className={`bg-white rounded-2xl shadow-lg p-8 border-4 ${
              ...
              <div className="text-center mb-6">
                ...
                <h2 className="text-3xl font-bold text-gray-900 mb-2">Seu Perfil Alimentar</h2>
