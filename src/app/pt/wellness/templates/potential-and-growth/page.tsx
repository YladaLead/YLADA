...
export default function QuizPotencialCrescimento({ config }: TemplateBaseProps) {
  ...
  const calcularResultado = (resps: number[]) => {
    ...
    const diagnostico = getDiagnostico('potencial-crescimento', 'wellness', diagnosticoId)
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        {etapa === 'landing' && (
          <WellnessLanding
            ...
            benefits={[
              'Identifique seu potencial de crescimento',
              'Descubra oportunidades de desenvolvimento',
              'Receba insights personalizados',
              'Conheça caminhos para acelerar seu crescimento',
              'Explore possibilidades de expansão'
            ]}
            onStart={iniciarQuiz}
