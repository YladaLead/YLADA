...
export default function TesteRetencaoLiquidos({ config }: TemplateBaseProps) {
  ...
  const calcularResultado = (resps: number[]) => {
    ...
    const diagnostico = getDiagnostico('retencao-liquidos', 'wellness', diagnosticoId)
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        {etapa === 'landing' && (
          <WellnessLanding
            ...
            benefits={[
              'Identifique seu nível de retenção de líquidos',
              'Descubra como reduzir inchaço e desconforto',
              'Receba recomendações personalizadas',
              'Tenha acesso a produtos específicos',
              'Melhore seu equilíbrio hidroeletrolítico'
            ]}
            onStart={iniciarQuiz}
