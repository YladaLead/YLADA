...
export default function QuizPropositoEquilibrio({ config }: TemplateBaseProps) {
  ...
  const calcularResultado = (resps: number[]) => {
    ...
    const diagnostico = getDiagnostico('proposito-equilibrio', 'wellness', diagnosticoId)
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        {etapa === 'landing' && (
          <WellnessLanding
            ...
            benefits={[
              'Identifique seu alinhamento com propósito',
              'Descubra oportunidades de equilíbrio',
              'Receba insights personalizados',
              'Conheça caminhos para viver seus sonhos',
              'Explore possibilidades de significado'
            ]}
            onStart={iniciarQuiz}
