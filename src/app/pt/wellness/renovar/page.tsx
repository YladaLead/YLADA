 ...
 * - Checkout direto (pode assinar com e-mail)
 */
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="space-y-4">
            <Link
              ...
              className="flex items-center justify-center gap-2 w-full bg-green-600 hover:bg-green-700 text-white py-4 px-6 rounded-lg font-semibold text-lg transition-colors"
            >
              💚 Assinar Agora
            </Link>
            ...
            <div className="border-t border-gray-200 pt-6 mt-6 space-y-3">
              <p className="text-sm text-gray-600 text-center">
                Já tem conta? Acesse para renovar:
              </p>
              <Link
                href="/pt/wellness/login?redirect=/pt/wellness/checkout"
