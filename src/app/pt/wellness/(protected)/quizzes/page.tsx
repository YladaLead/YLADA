...
export default function QuizzesWellnessPage() {
  return <QuizzesWellnessContent />
}

function QuizzesWellnessContent() {
  ...
  const carregarQuizzes = async () => {
    try {
      setLoading(true)
      const response = await fetch('/api/wellness/quizzes', {
        credentials: 'include'
      })
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <WellnessNavBar showTitle={true} title="Meus Quizzes" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <Link
            ...
            className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-4 py-2 rounded-lg hover:from-purple-700 hover:to-indigo-700 transition-all transform hover:scale-105 shadow-lg font-medium"
          >
            + Criar Quiz
          </Link>
        </div>
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-4">
                        <div
                          ...
                          style={{ backgroundColor: quiz.cores?.primaria || '#8B5CF6' }}
                        >
                          {quiz.emoji || '🎯'}
                        </div>
                        <div>
