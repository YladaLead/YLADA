  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link href="/pt" className="flex items-center gap-2">
              ...
              <span className="text-gray-500 text-sm">· Estética</span>
            </Link>
      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-lg sm:text-xl text-gray-700 mb-4">
                Atrair clientes interessados em procedimentos.
              </p>
              <p className="text-base sm:text-lg text-gray-600 mb-6">
                O cliente responde uma avaliação rápida antes do contato. Assim você entende necessidades, expectativas e o momento ideal para cada procedimento antes mesmo da primeira conversa.
              </p>
        ...
        <HeroBeforeAfter area="estetica" />

        <section className="py-12 sm:py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 text-center">
                Profissionais de estética enfrentam três dificuldades comuns no marketing online
              </h2>
              <ul className="space-y-4 text-gray-700">
                <li className="flex items-start gap-3">
                  <span className="text-red-500 font-bold shrink-0">•</span>
                  <span>Curiosos pedindo preço sem intenção real de agendar</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-red-500 font-bold shrink-0">•</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-red-500 font-bold shrink-0">•</span>
                  <span>Dificuldade de qualificar o interesse do cliente</span>
                </li>
              </ul>
              <p className="text-center text-gray-600 mt-8 font-medium">
                Isso consome tempo, gera conversas improdutivas e reduz a conversão em agendamentos.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 sm:py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 text-center">
                O YLADA ajuda você a atrair clientes interessados em procedimentos
              </h2>
              <p className="text-lg text-gray-700 mb-6 text-center">
                O cliente responde uma avaliação rápida antes do contato. Assim você entende necessidades e expectativas antes mesmo da primeira conversa.
              </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  { step: '1', title: 'Escolha uma avaliação', desc: 'Quizzes e diagnósticos prontos para estética.' },
                  { step: '2', title: 'Compartilhe o link', desc: 'Use em redes sociais, WhatsApp ou site.' },
                  { step: '3', title: 'O cliente responde', desc: 'O sistema identifica necessidades e expectativas.' },
                  { step: '4', title: 'Conversa com contexto', desc: 'Você atende clientes que realmente querem o procedimento.' },
                ].map((item) => (
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-start">
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-gray-400 font-mono">ylada.app/avaliacao/pele</p>
                  <div className="bg-white rounded-2xl p-5 shadow-lg border border-gray-100 max-w-sm">
                    <p className="text-xs text-gray-500 mb-2">Avaliação: &quot;Sua pele pode precisar de cuidados específicos?&quot;</p>
                    <div className="bg-blue-50 rounded-xl p-4 border-l-4 border-blue-500">
                      <p className="font-semibold text-gray-900 mb-2">Resultado do diagnóstico</p>
                      <p className="font-medium text-gray-800 mb-2">Perfil identificado: Interesse em tratamentos faciais</p>
                      <p className="text-sm text-gray-600 mb-3">Possíveis sinais:</p>
                      <ul className="text-sm text-gray-700 space-y-1">
                        <li>• preocupação com linhas de expressão</li>
                        <li>• interesse em hidratação</li>
                        <li>• disposição para cuidar da pele</li>
                      </ul>
                    </div>
                    <p className="text-xs text-gray-500 mt-3 italic">
                      Esse resultado sugere que uma avaliação pode ajudar a escolher o procedimento ideal.
                    </p>
                    <p className="text-xs text-gray-600 mt-2">
                      Isso gera curiosidade e abre espaço para agendar.
                    </p>
                  </div>
                  <div className="bg-[#dcf8c6] rounded-xl p-4 max-w-sm ml-4 border border-gray-200">
                    <p className="text-sm text-gray-800">
                      &quot;Gostaria de saber mais sobre os tratamentos. Como posso agendar?&quot;
                    </p>
                  ...
                  <div className="aspect-video bg-gray-200 rounded-xl flex items-center justify-center border-2 border-dashed border-gray-300">
                    <div className="text-center p-6">
                      ...
                      <p className="text-gray-400 text-xs max-w-[200px] mx-auto">
                        Vídeo curto mostrando: criar avaliação → enviar link → cliente responde → diagnóstico aparece → conversa começa
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <p className="text-gray-700 text-center mt-8 max-w-2xl mx-auto">
                Quando o cliente responde uma avaliação, ele começa a refletir sobre suas necessidades. Isso gera interesse e abertura para agendar.
              </p>
        ...
        <section className="py-12 sm:py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 text-center">
                Avaliações usadas por profissionais de estética
              </h2>
              ...
              <ul className="space-y-3 text-gray-700 mb-6">
                {[
                  'Sua pele pode precisar de cuidados específicos?',
                  'Você está pronto para investir em procedimentos estéticos?',
                  'Seu tipo de pele pode se beneficiar de qual tratamento?',
                ].map((item) => (
              ...
              <p className="text-gray-600 text-center text-sm">
                Essas avaliações ajudam a atrair clientes interessados em procedimentos.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  'Clientes que entendem o valor do procedimento',
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <blockquote className="mt-3 text-gray-800 italic border-l-4 border-blue-500 pl-4 py-2 bg-blue-50/50 rounded-r-lg">
                &quot;Vi que você respondeu a avaliação sobre cuidados com a pele. Quer agendar uma avaliação para conversarmos sobre os procedimentos?&quot;
              </blockquote>
            </div>
          </div>
        </section>
