 ...
 * Tour socrático: /pt/estetica/apresentacao. Entrada principal (quiz): /pt/estetica.
 */
...
const EXEMPLOS_ESTETICA = [
  { titulo: 'Sua pele está pedindo mais cuidados?', href: '/pt/diagnostico?area=2' },
  { titulo: 'Qual procedimento combina com seu objetivo?', href: '/pt/diagnostico?area=2' },
  { titulo: 'Sua rotina de cuidados está adequada?', href: '/pt/diagnostico?area=2' },
  { titulo: 'Você está pronto para agendar uma avaliação?', href: '/pt/diagnostico?area=2' },
]

const HOW_IT_WORKS_ESTETICA = [
  { title: 'Criar diagnóstico', desc: 'Transforme seu conhecimento em perguntas que revelam a necessidade do cliente (pele, procedimentos, rotina).' },
  ...
  { title: 'Conversa com contexto', desc: 'O cliente chega com mais clareza e o agendamento avança com mais facilidade.' },
]

export default function EsteticaInstitutionalContent() {
  ...
  useEffect(() => {
    if (loading || !isEsteticaPage) return
    if (user) {
      router.replace('/pt/estetica/home')
    }
  }, [loading, user, pathname, router, isEsteticaPage])

  const showAuthLoading = loading && isEsteticaPage && !authTimeout
  if (showAuthLoading) {
    return (
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-50 border-b border-gray-200 bg-white shadow-sm h-[72px] flex items-center safe-area-inset-top">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-full">
          <Link href="/pt" className="flex items-center gap-2 flex-shrink-0 touch-manipulation" aria-label="YLADA início">
            ...
            <span className="text-gray-500 text-sm font-medium hidden sm:inline">· Estética</span>
          </Link>
          <nav className="flex items-center gap-3 sm:gap-6">
            <Link href="/pt/diagnostico?area=2" className="text-gray-600 hover:text-gray-900 text-sm font-medium hidden md:inline">
              Fazer diagnóstico
            </Link>
            ...
            <Link href="/pt/estetica/login" className="text-gray-600 hover:text-gray-900 text-sm font-medium">
              Entrar
            </Link>
            <Link
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="space-y-2 mb-6">
                  {[
                    ...
                    { label: 'Conversas que não viram agendamento', value: 1 },
                    { label: 'Clientes realmente preparados para agendar', value: 2 },
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (respostaHeroIdx !== null) {
                        ...
                        router.push(`/pt/diagnostico?fromHome=1&area=2&problema=${problemaValue}`)
                      }
                    }}
        ...
        <DemoCarouselYLADA initialArea="estetica" />

        {/* IDENTIFICAÇÃO DO PROBLEMA — 100% estética, dor agenda vazia */}
        <section className="bg-gray-50 py-12 sm:py-16 lg:py-20 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-xl sm:text-3xl font-bold text-gray-900 mb-6 sm:mb-8 text-center">
              A maioria dos profissionais de estética explica demais antes do primeiro contato.
            </h2>
            <ul className="space-y-3 text-gray-700 mb-6">
              ...
              <li className="flex items-start gap-3">
                <span className="text-red-500 mt-1">•</span>
                <span>Conversas que não viram agendamento</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-red-500 mt-1">•</span>
                <span>Clientes que não entendem o valor do procedimento</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-red-500 mt-1">•</span>
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-white">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto px-4">
            {HOW_IT_WORKS_ESTETICA.map((item, i) => (
        ...
        <section className="bg-gray-50 py-10 sm:py-14 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
          <div className="max-w-xl mx-auto text-center">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              Quando uma pessoa responde perguntas sobre a própria pele, procedimentos ou rotina de cuidados, ela começa a entender a necessidade antes da conversa.
            </p>
            <div className="flex flex-col items-center gap-2 py-6 px-6 bg-white rounded-xl border border-gray-100 max-w-xs mx-auto shadow-sm">
              ...
              <span className="text-gray-400">↓</span>
              <span className="text-sm font-bold text-gray-900">Cliente / Agendamento</span>
            </div>
            <p className="text-lg font-semibold text-gray-900 mt-6">
              Quando o cliente entende o que precisa, a conversa e o agendamento mudam.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 sm:py-16 lg:py-20">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-xl sm:text-3xl font-bold text-gray-900 text-center mb-4">
              Exemplos de diagnósticos para estética
            </h2>
            <div className="grid sm:grid-cols-2 gap-4 mb-6">
              {EXEMPLOS_ESTETICA.map((ex, i) => (
                <Link
                  key={i}
                  href={ex.href}
            ...
            <p className="text-center text-gray-600 text-sm">
              Esses são exemplos de diagnósticos que profissionais de estética podem criar com YLADA.
            </p>
          </div>
        </section>
        ...
        <section className="bg-gray-50 py-12 sm:py-16 lg:py-20 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">
              Profissionais de estética usam diagnósticos para:
            </h2>
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-center justify-center gap-2">
                <span className="text-green-600">✔</span>
                <span>atrair clientes mais interessados em procedimentos</span>
              </li>
              <li className="flex items-center justify-center gap-2">
                <span className="text-green-600">✔</span>
                <span>evitar conversas que não viram agendamento</span>
              </li>
              <li className="flex items-center justify-center gap-2">
                <span className="text-green-600">✔</span>
                <span>explicar valor do procedimento com mais facilidade</span>
              </li>
              <li className="flex items-center justify-center gap-2">
                <span className="text-green-600">✔</span>
        ...
        <YladaProfissionaisGridSection locale={locale} highlightCodigo="estetica" />
        ...
        <div className="w-full max-w-7xl mx-auto px-4 py-8 sm:py-10">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <nav className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 mb-6 text-sm">
              <Link href="/pt/diagnostico?area=2" className="text-gray-600 hover:text-gray-900">Fazer diagnóstico</Link>
