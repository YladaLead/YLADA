...
const STEPS: StepBody[] = [
  ...
  },
  {
    lines: [
      ...
      '',
      'Você posta…',
      'mas quase não vira cliente',
      '',
      'Às vezes até chama gente…',
      'mas não vira agendamento',
      '',
  ...
  },
  {
    lines: [
      'E não é você.',
      '',
      'O problema não é o seu procedimento.',
      '',
  ...
  },
  {
    lines: [
      ...
      '',
      'Já entendendo melhor a própria pele',
      'Já com mais noção do que precisa',
      'E mais pronta pra agendar',
    ],
  ...
  },
  {
    lines: [
      ...
      'e pensar sobre o que está acontecendo com ela',
    ],
    primary: { label: 'Continuar', action: 'next' },
  },
  {
  ...
  },
  {
    lines: [
      ...
      '',
      'ela começa a perceber melhor o que precisa',
      '',
      'Antes mesmo de te chamar',
      '',
      'E a conversa já começa diferente',
    ],
    primary: { label: 'Continuar', action: 'next' },
  },
  {
