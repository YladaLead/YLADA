    ...
    <YladaAreaShell areaCodigo="coach-bem-estar" areaLabel="Coach de bem-estar">
      <div className="mx-auto max-w-2xl">
        ...
        <p className="mt-2 text-sm leading-relaxed text-gray-600">
          Ferramentas para quem também constrói equipe: os mesmos diagnósticos e fluxos de recrutamento da base
          operacional (links públicos continuam em wellness por enquanto), num canto separado do foco do dia a dia.
        </p>

        <ul className="mt-8 space-y-3">
          <li>
            <Link
              href="/pt/wellness/links?tipo=recrutamento"
            ...
            >
              ...
              <span className="mt-1 block text-xs text-gray-500">
                Quizzes, fluxos rápidos e HOM — filtro só de recrutamento em Meus Links.
              </span>
