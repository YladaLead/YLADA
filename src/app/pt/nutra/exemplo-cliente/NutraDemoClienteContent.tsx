...
const CADASTRO_POS_DEMO_HREF = '/pt/cadastro?area=nutra'
        ...
        <main className="flex-1 px-4 py-8 max-w-lg mx-auto w-full flex flex-col estetica-safe-main-bottom space-y-10">
          <div className="space-y-5 text-center">
            ...
            <p className="text-sm text-gray-700 font-medium leading-relaxed max-w-md mx-auto pt-1">
              Pelas respostas, seu cliente fica com mais clareza, mais decidido a mudar o que precisa e com mais vontade
          ...
          {veioDaMatriz ? (
            <div className="space-y-3 pt-2">
              <Link
                ...
                onClick={() =>
                  trackEvent('nutra_cadastro_promo_cta', { area: 'nutra', origem: 'matriz_exemplo_cliente' })
                }
              ...
              <p className="text-center text-sm text-gray-600 leading-relaxed px-1">
                Crie seu link e comece a atrair clientes mais prontos em menos de 1 minuto.
              </p>
            </div>
          ) : (
            <button
