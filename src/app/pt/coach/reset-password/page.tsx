    ...
    try {
      if (token) {
        ...
        if (data.session) {
          ...
          setTimeout(() => {
            router.push('/pt/coach/login?password_reset=success')
          }, 2000)
        }
      } else {
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  minLength={6}
                  className="w-full px-4 py-3 pr-10 border border-gray-300 rounded-lg transition-all focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none text-gray-900 placeholder-gray-400"
                  placeholder="••••••••"
                />
                <button
                  type="button"
