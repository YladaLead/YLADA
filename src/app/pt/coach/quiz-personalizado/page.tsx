            ...
            <div className="space-y-3">
              {pergunta.opcoes.map((opcao, index) => (
                <label key={index} className="flex items-center space-x-3 p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                  <input type="radio" name={`pergunta-${perguntaIndex}`} className="text-purple-600" />
                  <span>{opcao}</span>
                </label>
              ))}
            </div>
          ...
          <div className={`${etapaAtual === 4 ? 'w-full' : 'lg:col-span-1'}`}>
            ...
            {etapaAtual === 1 && (
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                    ...
                    <div className="flex items-start space-x-3">
                      <div className="relative">
                        <input
                          ...
                          className="w-20 border border-gray-300 rounded-lg px-3 py-2 pr-8 text-center text-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                          value={quiz.emoji}
                      ...
                      <div className="flex-1">
                        <input
                          type="text"
                          placeholder="Ex: Quiz de Avaliação Coachcional Completa"
                ...
                <div className="bg-gradient-to-r from-purple-50 to-purple-50 p-4 rounded-lg border border-purple-200 mb-6">
                  <h4 className="font-medium text-purple-900 mb-3 flex items-center text-sm">
                  ...
                  <div className="space-y-3 text-sm text-purple-800">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="bg-white p-2 rounded-lg border border-purple-100">
                        <p className="font-semibold text-purple-900 text-xs">📚 Educar</p>
                      </div>
                      <div className="bg-white p-2 rounded-lg border border-purple-100">
                        <p className="font-semibold text-purple-900 text-xs">🤝 Servir</p>
                      </div>
                      <div className="bg-white p-2 rounded-lg border border-purple-100">
                        <p className="font-semibold text-purple-900 text-xs">🎯 Engajar</p>
                      </div>
                      <div className="bg-white p-2 rounded-lg border border-purple-100">
                        <p className="font-semibold text-purple-900 text-xs">💼 Converter</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {tiposPergunta.map((tipo) => (
                      ...
                      >
                        ...
                        <p className="text-xs text-purple-600">{tipo.dica}</p>
                      </button>
                    ))}
                  </div>
                </div>
                          ...
                          <div className="flex justify-between items-start">
                            ...
                            <div className="flex items-center space-x-1">
                              ...
                              <button
                                ...
                                className="text-purple-500 hover:text-purple-700 hover:bg-purple-50 p-2 rounded-lg transition-colors"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 flex flex-col">
                 ...
                 <div className="bg-purple-50 rounded-lg p-4">
                   <h3 className="text-sm font-medium text-purple-900 mb-3">📊 Configurações de Coleta de Dados</h3>
                     ...
                     <div>
                      <label className="flex items-center space-x-2">
                        <input
                          ...
                          className="rounded border-gray-300 text-purple-600 focus:ring-purple-500"
                        />
                         <span className="text-sm text-purple-800">Coletar dados do cliente na página de resultado</span>
                       </label>
                       
                       {quiz.entrega.coletarDados && (
                         <div className="ml-6 mt-3 space-y-2">
                           <h4 className="text-xs font-medium text-purple-700">Campos para coletar:</h4>
                           <div className="space-y-2">
                             <div className="flex items-center space-x-2">
                               <input
                                 type="checkbox"
                ...
                <div className="bg-purple-50 rounded-lg p-4">
                  <h3 className="text-sm font-medium text-purple-900 mb-3">🔗 Configurações de Redirecionamento</h3>
                      ...
                      <>
                        ...
                        <div>
                          ...
                          <div className="mt-2 bg-purple-50 rounded-lg p-3">
                            <p className="text-xs text-purple-700 font-medium mb-1">💡 Como funciona:</p>
                                     ...
                                     if (value.length >= 3) {
                                       ...
                                       try {
                                         const response = await fetch(
                                           `/api/coach/check-short-code?code=${encodeURIComponent(value)}&type=quiz`
                                         )
                                         const data = await response.json()
                 ...
                 <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                   ...
                   <div className="text-sm text-green-800">
                     ...
                     <code className="text-xs bg-white p-2 rounded border block break-all">
                       ylada.app/pt/coach/seu-nome/quiz-personalizado
                     </code>
                ...
                {Array.from({ length: calcularTotalPaginas() }, (_, index) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-colors ${
                      index === paginaPreviewAtual ? 'bg-purple-600' : 'bg-gray-300'
                    }`}
                  />
                ))}
              </div>
