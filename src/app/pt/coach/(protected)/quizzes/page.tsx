...
export default function QuizzesCoachPage() {
  return <QuizzesCoachContent />
}

function QuizzesCoachContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CoachNavBar showTitle={true} title="Meus Quizzes" />
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-xl font-bold text-purple-600">{quiz.totalRespostas}</p>
                      </div>
                      <div>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                      ...
                      <div className="flex flex-col space-y-2 ml-4 text-right sm:flex-row sm:items-center sm:space-y-0 sm:space-x-4 sm:text-left">
                        ...
                        <Link
                          href={`/pt/coach/quiz-personalizado?quizId=${quiz.id}`}
