...
function NovaFerramentaCoachContent() {
  ...
  useEffect(() => {
    if (configuracao.urlPersonalizada && templateSelecionado) {
      ...
      const url = `${baseUrl}/pt/c/${urlNome}/${configuracao.urlPersonalizada}`
  ...
  const salvarFerramenta = async () => {
    try {
      ...
      mensagemSucesso.className = 'fixed top-4 right-4 bg-purple-50 border-2 border-purple-400 rounded-lg shadow-lg p-4 z-50 max-w-md'
      mensagemSucesso.innerHTML = `
        <div class="flex items-start space-x-3">
          ...
          <div class="flex-1">
            <h3 class="text-sm font-bold text-purple-900 mb-1">Ferramenta criada com sucesso!</h3>
            <p class="text-xs text-purple-700 mb-2">Sua ferramenta está pronta para uso.</p>
            <div class="bg-white rounded p-2 mb-2 border border-purple-200">
              ...
              class="text-xs text-purple-700 hover:text-purple-900 underline"
              >
              Copiar URL
              </button>
            </div>
          <button 
            ...
            class="text-purple-600 hover:text-purple-800 text-lg font-bold"
          >
            ×
          </button>
            </div>
      ...
      setTimeout(() => {
        ...
        window.location.href = '/pt/coach/ferramentas'
      }, 5000)
    } catch (error: any) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {!templateSelecionado && mostrarIntroducao && (
          <div className="mb-8 bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-6 border-2 border-purple-200 shadow-lg">
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-gray-900 mb-3 flex items-center">
                  <span className="text-3xl mr-3">👋</span>
                  Bem-vindo ao Criador de Ferramentas Coach!
                </h2>
        ...
        {!templateSelecionado && (
          <>
              ...
              <div className="relative">
                  ...
                  className="w-full px-4 py-3 pl-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent text-lg"
                />
                ...
                >
                  <div className="p-6">
                    <div className="flex items-center space-x-4 mb-4">
                      <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-blue-600 rounded-xl flex items-center justify-center text-3xl group-hover:scale-110 transition-transform">
                        {template.icon}
                      </div>
                      <div>
        ...
        {templateSelecionado && (
          <div className="grid lg:grid-cols-2 gap-8">
            {/* Coluna Esquerda: Formulário */}
              ...
              <div id="configuracao" className="bg-white rounded-xl border-2 border-purple-200 p-8">
                <div className="space-y-6">
                            ...
                            <div className="mt-4 p-4 bg-purple-50 rounded-lg border border-purple-200">
                              ...
                              <div className="mt-3 p-3 bg-purple-100 rounded-lg">
                                <p className="text-xs text-purple-800">
                                  ...
                                  • <strong className="text-purple-900">{userSlug || '[seu-nome-url]'}</strong> = Seu nome único na URL (configurado no perfil)<br/>
                                  • <strong className="text-purple-900">{configuracao.urlPersonalizada || '[nome-projeto]'}</strong> = Nome do projeto que você escolher<br/>
                                  <br/>
                                              ...
                                              if (value.length >= 3) {
                                                ...
                                                try {
                                                  const response = await fetch(
                                                    `/api/c/check-short-code?code=${encodeURIComponent(value)}`
                                                  )
                                                  const data = await response.json()
                    ...
                    {abaCTA && (
                      ...
                      <div>
                          ...
                          <p className="text-xs text-gray-500 mb-3">
                            💡 <strong>O que é?</strong> Cores do botão que o cliente verá. Use tons de azul para Coach
                          </p>
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <input
                                  ...
                                  value={configuracao.cores.principal}
                                  onChange={(e) => setConfiguracao({ ...configuracao, cores: { ...configuracao.cores, principal: e.target.value } })}
                                  className="flex-1 min-w-0 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"
                                />
                            </div>
                        </div>
                        <div>
                          ...
                          <div className="flex-1">
                            ...
                            <div>
                              ...
                              <div className="mt-2 bg-purple-50 rounded-lg p-3">
                                <p className="text-xs text-purple-700 font-medium mb-1">💡 Placeholders disponíveis:</p>
                      ...
                      <input
                        ...
                        <div className="mt-6 p-4 bg-purple-50 rounded-lg border border-purple-200">
                          <label className="flex items-center space-x-2 mb-3">
                            ...
                            />
                            <span className="text-sm font-medium text-purple-900">Coletar dados do cliente antes do resultado</span>
                          </label>
                          
                          {configuracao.coletarDados && (
                            <div className="ml-6 mt-3 space-y-2">
                              <h4 className="text-xs font-medium text-purple-700 mb-2">Campos para coletar:</h4>
                              <div className="space-y-2">
                                <div className="flex items-center space-x-2">
                                  <input
                                    ...
                                    className="rounded border-gray-300 text-purple-600 focus:ring-purple-500"
                                  />
                                  <span className="text-sm text-purple-700">Nome</span>
                                </div>
                                <div className="flex items-center space-x-2">
                                  <input
                                    type="checkbox"
...
export default function NovaFerramentaCoach() {
  return (
    <Suspense fallback={
