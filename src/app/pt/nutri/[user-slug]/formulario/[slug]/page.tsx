  ...
  useEffect(() => {
    ...
    const carregarFormulario = async () => {
      try {
        ...
        const response = await fetch(`/api/public/formularios/by-slug?user_slug=${encodeURIComponent(userSlug)}&slug=${encodeURIComponent(slug)}`)
            ...
            <input
              ...
              onChange={async (e) => {
                ...
                try {
                  ...
                  formData.append('formId', formulario.id)
                  formData.append('fieldId', field.id)
                  
                  const uploadResponse = await fetch(`/api/public/formularios/${formulario.id}/upload`, {
                    method: 'POST',
                    body: formData
                  })
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          {responseId && (
            <a
              href={`/f/${formulario.id}/resposta/${responseId}`}
