...
const statusColumns = [
  { value: 'lead', label: 'Contato', description: 'Entrou agora, precisa de acolhimento', color: 'border-blue-200 bg-blue-50' },
...
function KanbanColumn({
  ...
  return (
    <div
      ref={setNodeRef}
      className={`flex flex-col rounded-2xl border bg-white ${color} ${isOver ? 'ring-2 ring-blue-400 ring-offset-1' : ''} min-h-[500px]`}
    >
