          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="mt-6 text-sm sm:text-base text-gray-600 text-center font-semibold">
                No final, se fizer sentido, você conhece o <strong className="text-gray-900">Método YLADA</strong> (R$300/mês ou anual em 12x de R$150) para estabilizar sua agenda com estrutura e acompanhamento.
              </p>
            </div>
          </div>
        </section>
