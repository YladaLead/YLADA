...
const STEPS: StepBody[] = [
  ...
  },
  {
    lines: [
      ...
      '',
      'Você posta…',
      'mas quase não vira paciente de verdade',
      '',
      'Às vezes até chama gente…',
      'mas não vira consulta ou plano',
      '',
  ...
  },
  {
    lines: [
      'E não é você.',
      '',
      'O problema não é a sua orientação no consultório.',
      '',
  ...
  },
  {
    lines: [
      ...
      '',
      'Já com mais noção de hábitos e rotina',
      'Já alinhada com o próprio objetivo de saúde',
      'E mais pronta pra consulta ou plano',
    ],
  ...
  },
  {
    lines: [
      ...
      'e pensar na rotina, no objetivo e na prioridade dela',
    ],
    primary: { label: 'Continuar', action: 'next' },
  },
  {
