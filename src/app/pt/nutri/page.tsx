          ...
          <div className="container mx-auto px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                ...
                <br />
                <span className="text-blue-600">sem precisar depender de indicações ou redes sociais.</span>
              </h1>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                <div className="grid grid-cols-2 divide-x divide-gray-200">
                  ...
                  <div className="p-6 bg-blue-50">
                    <h3 className="text-lg font-bold text-blue-600 mb-4 text-center">YLADA Nutricionista</h3>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-gray-600 text-sm mb-2 text-center">
              YLADA Nutricionista — Your Lead Advanced Data Assistant
            </p>
