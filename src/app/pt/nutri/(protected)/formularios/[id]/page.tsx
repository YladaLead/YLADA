...
export default function EditarFormularioNutri() {
  return <EditarFormularioNutriContent />
}
  ...
  useEffect(() => {
    ...
    const carregarFormulario = async () => {
      try {
        ...
        setTimeout(() => router.push('/pt/nutri/formularios'), 2000)
      } finally {
        setCarregando(false)
      }
    }
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2">
                  <TooltipButton
                    ...
                    className="px-3 py-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition-colors text-sm font-medium border border-blue-200"
