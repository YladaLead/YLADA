...
export default function PDF2IdentidadePosturaPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 flex items-center gap-2 text-sm text-gray-500">
          ...
          <span className="text-gray-400">→</span>
          <span className="text-gray-700 font-medium">Identidade & Postura Profissional</span>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 mb-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-4">
            <div>
              <Heading level={1} className="mb-2">Identidade & Postura Profissional (Nutri-Empresária)</Heading>
              <Paragraph className="text-lg text-gray-600 mb-0">
                Fundamentos da transformação profissional: como se posicionar como Nutri-Empresária.
              </Paragraph>
            </div>
            <Link
          ...
          <ContentContainer>
            <Section>
              <Paragraph className="text-center italic text-gray-500 py-8">
                Conteúdo será inserido em breve.
              </Paragraph>
            </Section>
          </ContentContainer>
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4">
          <Link href="/pt/nutri/metodo/biblioteca" className="px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-all duration-200 ease-out hover:shadow-md hover:opacity-90 font-medium text-center">
