...
export default function PDF3RotinaProdutividadePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6 flex items-center gap-2 text-sm text-gray-500">
          ...
          <span className="text-gray-400">→</span>
          <span className="text-gray-700 font-medium">Rotina & Produtividade YLADA</span>
        </div>
        <div className="bg-white rounded-xl p-6 mb-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-4">
            <div>
              <Heading level={1} className="mb-2">Rotina & Produtividade YLADA</Heading>
              <Paragraph className="text-lg text-gray-600 mb-0">Como organizar sua rotina mínima e maximizar sua produtividade.</Paragraph>
            </div>
