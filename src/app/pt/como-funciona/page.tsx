            ...
            <div className="grid sm:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                ...
                <ul className="text-gray-600 text-sm space-y-2">
                  <li>• Links genéricos sem personalização</li>
                  <li>• Sem dados sobre seus visitantes</li>
                  <li>• Ferramentas complexas e caras</li>
                  <li>• Tempo perdido com configurações</li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                ...
                <ul className="text-gray-600 text-sm space-y-2">
                  <li>• Links inteligentes e personalizados</li>
                  <li>• Dados detalhados em tempo real</li>
                  <li>• Ferramentas simples e eficazes</li>
                  <li>• Resultados em 60 segundos</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <p className="text-gray-600 text-sm text-center">
                  Quiz de perfil metabólico que qualifica leads e agenda consultas automaticamente.
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <p className="text-gray-600 text-sm text-center">
                  Calculadora de necessidades que aumenta conversões em 300% e qualifica clientes.
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <p className="text-gray-600 text-sm text-center">
                  Avaliação de bem-estar que engaja clientes e aumenta retenção em 250%.
                </p>
              </div>
            </div>
          </div>
