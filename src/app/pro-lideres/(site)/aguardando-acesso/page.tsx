  ...
  return (
    <div className="mx-auto max-w-md space-y-6 text-center">
      ...
      <p className="text-base text-gray-600">
        ...
        link que recebeu. Se você é líder e ainda não tem espaço ativo na YLADA, fale conosco.
      </p>
      <div className="mx-auto flex w-full max-w-xs flex-col gap-3">
        <a
          ...
          className="inline-flex min-h-[48px] w-full items-center justify-center gap-2.5 rounded-xl bg-[#25D366] px-5 py-3 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#20bd5a]"
        >
