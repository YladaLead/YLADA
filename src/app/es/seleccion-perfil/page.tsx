...
export default function SeleccionPerfilPageES() {
            ...
            <div className="grid sm:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">
                  🤔 ¿No encajas en ningún perfil?
                </h3>
                <p className="text-gray-600 text-sm mb-4">
                  YLADA funciona para cualquier profesional que quiera conectarse mejor con su audiencia.
                </p>
                <Link 
                  href="/es/plantillas"
                  className="text-blue-600 hover:text-blue-700 text-sm font-medium"
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Ve cómo otros profesionales están usando YLADA para hacer crecer sus negocios.
                </p>
                <Link 
                  href="/es/plantillas"
                  className="text-blue-600 hover:text-blue-700 text-sm font-medium"
