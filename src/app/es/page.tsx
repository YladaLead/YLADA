        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 hover:border-blue-300">
              ...
              <h3 className="text-lg font-bold mb-3 text-gray-900 text-center">Simplicidad</h3>
              <p className="text-gray-600 text-sm leading-relaxed text-center">
                <span className="text-blue-600 font-semibold">Un enlace, infinitas posibilidades</span>. 
                Transforma cualquier idea en una herramienta inteligente en segundos.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 hover:border-blue-300">
              ...
              <h3 className="text-lg font-bold mb-3 text-gray-900 text-center">Inteligencia</h3>
              <p className="text-gray-600 text-sm leading-relaxed text-center">
                <span className="text-blue-600 font-semibold">IA que entiende tu audiencia</span>. 
                Cada herramienta está optimizada para convertir visitantes en conexiones reales.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 hover:border-blue-300 sm:col-span-2 lg:col-span-1">
              ...
              <h3 className="text-lg font-bold mb-3 text-gray-900 text-center">Escalabilidad</h3>
              <p className="text-gray-600 text-sm leading-relaxed text-center">
                <span className="text-blue-600 font-semibold">Crece sin límites</span>. 
                Desde la primera conexión hasta millones de usuarios, YLADA escala contigo.
              </p>
            </div>
          </div>
