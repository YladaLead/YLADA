...
export default async function PublicLinkMemberSegmentPageEs({ params, searchParams }: PageProps) {
  ...
  return <PublicLinkView payload={payload} locale="es" shareAttributionToken={shareToken} />
}
