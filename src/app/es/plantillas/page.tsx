...
export default function TemplatesPageES() {
  ...
  // Mock data - plantillas compartidas
  const templates = [
    {
      id: 1,
      title: 'Calculadora de IMC Inteligente',
      description: 'Calcula e interpreta el IMC con recomendaciones personalizadas',
    ...
    },
    {
      ...
      description: 'Descubre el tipo metabólico del cliente en minutos',
    ...
    },
    {
      ...
      description: 'Calcula el retorno de inversiones en marketing',
      objective: 'capture-leads',
      profession: 'sales',
      icon: '💰',
      color: 'blue',
    ...
    {
      id: 4,
      title: 'Quiz de Productos',
      description: 'Descubre el producto ideal para cada cliente',
      objective: 'increase-sales',
      profession: 'sales',
      icon: '💊',
      color: 'blue',
    ...
    {
      id: 5,
      title: 'Quiz de Bienestar',
      description: 'Descubre el nivel de bienestar del cliente',
      objective: 'increase-sales',
      profession: 'coach',
      icon: '🧘‍♀️',
      color: 'purple',
    ...
    {
      id: 6,
      title: 'Lista de Verificación de Crecimiento',
      description: 'Evalúa tu potencial de crecimiento y crea estrategias',
      category: 'checklist',
      profession: 'all',
      icon: '📈',
      color: 'yellow',
      ...
      <main className="container mx-auto px-4 py-4 sm:py-6 lg:py-8">
        ...
        <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 border border-gray-200 mb-12">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              <span className="font-semibold text-blue-600">{filteredTemplates.length}</span> plantillas encontradas
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-2xl p-8 sm:p-12 border border-gray-200 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Crea tu propia plantilla personalizada en minutos. Nuestra IA te ayuda a construir herramientas únicas para tu negocio.
          </p>
