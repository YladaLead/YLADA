        ...
        {loading ? (
          ...
          <div className="space-y-3 text-center">
            ...
            <p className="text-sm text-gray-600">
              Seu micro-diagnóstico inicial já está conosco. Quando você entrar no YLADA Pro — Estética Capilar com esse
          ...
          <div className="space-y-4">
            <div className="space-y-2 text-center">
              <p className="text-xs font-semibold uppercase tracking-wide text-blue-600">Estética Capilar</p>
