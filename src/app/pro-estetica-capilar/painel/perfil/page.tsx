  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <h1 className="text-2xl font-bold text-gray-900">Perfil da clínica (capilar)</h1>
        <p className="mt-1 text-sm text-gray-600">
          Dados da tua clínica no Pro Estética Capilar (nome, contacto e notas de foco comercial).
        </p>
      </div>
