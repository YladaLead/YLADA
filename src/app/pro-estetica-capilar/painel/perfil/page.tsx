  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <h1 className="text-2xl font-bold text-gray-900">Perfil da clínica — Estética capilar</h1>
        <p className="mt-1 text-sm text-gray-600">
          Dados da tua clínica no YLADA Pro — Estética capilar (nome, contacto e notas de foco comercial).
        </p>
      </div>
