...
export async function POST(request: NextRequest) {
  ...
  const userMessage = `Gera o JSON para o pilar "${pillar}" e o propósito acima. Regra absoluta: cada entries[].body é texto que o DISTRIBUIDOR envia a CLIENTE/LEAD/PÚBLICO (copiar/colar), nunca mensagem "Olá equipe" nem ao grupo interno. Só JSON.`
