...
export async function PATCH(
  ...
  if (fetchErr) {
    console.error('[pro-estetica-capilar/flows PATCH] fetch entry', fetchErr)
  ...
  if (error) {
    console.error('[pro-estetica-capilar/flows PATCH]', error)
...
export async function DELETE(
  ...
  if (error) {
    console.error('[pro-estetica-capilar/flows DELETE]', error)
