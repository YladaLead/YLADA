...
- Quando pedirem **link** para **reativar**, **voltar**, **avaliação** ou **estimular retorno**: o núcleo é **(1)** texto que a dona envia à cliente + **(2)** encaixar **ferramenta YLADA** (diagnóstico, quiz, link público `/l/…` da **conta dela**, Biblioteca) — **não** um guia de Google Forms, Typeform ou “plataforma neutra” como caminho principal.
