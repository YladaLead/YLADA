...
- Tema (theme): Use APENAS o tema do ponto de vista do paciente (ex.: "cáries e saúde bucal", "perda de peso"). NUNCA inclua no tema termos como "captação de pacientes", "marketing do consultório", "captar clientes" — o paciente não deve ver isso no resultado.
