        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 hover:border-blue-300">
              ...
              <h3 className="text-lg font-bold mb-3 text-gray-900 text-center">Simplicity</h3>
              <p className="text-gray-600 text-sm leading-relaxed text-center">
                <span className="text-blue-600 font-semibold">One link, infinite possibilities</span>. 
                Transform any idea into an intelligent tool in seconds.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 hover:border-blue-300">
              ...
              <h3 className="text-lg font-bold mb-3 text-gray-900 text-center">Intelligence</h3>
              <p className="text-gray-600 text-sm leading-relaxed text-center">
                <span className="text-blue-600 font-semibold">AI that understands your audience</span>. 
                Every tool is optimized to convert visitors into real connections.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 hover:border-blue-300 sm:col-span-2 lg:col-span-1">
              ...
              <h3 className="text-lg font-bold mb-3 text-gray-900 text-center">Scalability</h3>
              <p className="text-gray-600 text-sm leading-relaxed text-center">
                <span className="text-blue-600 font-semibold">Grow without limits</span>. 
                From the first connection to millions of users, YLADA scales with you.
              </p>
            </div>
          </div>
