...
export const SEGMENTOS_DORES_OBJETIVOS: SegmentoDoresObjetivos[] = [
  ...
  },
  {
    ...
    temas: [
      { value: 'joias_estilo_pessoal', label: 'Estilo e personalidade' },
      { value: 'joias_classica_moderna', label: 'Clássica, moderna ou ousada' },
      { value: 'joias_pedra_curiosidade', label: 'Pedras e curiosidade' },
      { value: 'joias_ouro_prata', label: 'Ouro ou prata na pele' },
      { value: 'joias_ocasiao', label: 'Ocasião e evento' },
      { value: 'joias_compra_impulso', label: 'Compra: impulso ou estratégia' },
      { value: 'joias_mix_colares', label: 'Mix e colares em camadas' },
      { value: 'joias_brinco_rosto', label: 'Brinco e formato de rosto' },
      { value: 'joias_erros_comuns', label: 'Erros comuns com acessórios' },
      { value: 'joias_ajuste_visual', label: 'Ajuste visual e renovação' },
      { value: 'joias_presente_ideal', label: 'Presente ideal' },
      { value: 'joias_minimal_ou_chamativo', label: 'Minimalista ou chamativo' },
    ],
    dores: [
      'Não sei que bijuteria combina comigo',
      'Dúvida entre ouro e prata para valorizar a pele',
      'Medo de errar o acessório na ocasião',
      'Compras por impulso e peças paradas',
      'Dúvida em combinar colares e proporções',
      'Brinco ou tamanho que não valoriza o rosto',
      'Look “quase bom” por detalhe de acessório',
      'Presente difícil de acertar',
    ],
    objetivos: [
      'Gerar curiosidade e identificação no story/reels',
      'Educar com leveza e autoridade',
      'Qualificar estilo antes do catálogo',
      'Aumentar comentários, saves e compartilhamentos',
      'Abrir conversa no WhatsApp com intenção',
      'Viralizar com perguntas rápidas',
      'Mostrar que pequenos ajustes mudam o visual',
      'Transformar descoberta em contato qualificado',
    ],
  },
  {
