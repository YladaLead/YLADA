...
export const SEGMENTOS_DORES_OBJETIVOS: SegmentoDoresObjetivos[] = [
  ...
  },
  {
    ...
    temas: [
      { value: 'joias_linha', label: 'Linha de produto' },
      { value: 'joias_estilo', label: 'Estilo e ocasião' },
      { value: 'joias_whatsapp', label: 'Atendimento e WhatsApp' },
      { value: 'joias_marca', label: 'Marca própria' },
      { value: 'joias_presente', label: 'Presentes e datas' },
      { value: 'joias_cuidados', label: 'Cuidados com as peças' },
      { value: 'joias_equipe', label: 'Revenda e equipe' },
      { value: 'joias_canal', label: 'Instagram, loja e site' },
    ],
    dores: [
      'Conversa no WhatsApp só vira preço',
      'Cliente não entende diferença entre semijoia e bijuteria',
      'Dificuldade em qualificar antes do catálogo',
      'Marca própria sem narrativa clara',
      'Presentes sem orientação geram devolução ou arrependimento',
      'Cliente não sabe cuidar da peça e reclama depois',
      'Equipe de revenda com discurso desalinhado',
      'Tráfego no Instagram que não vira pedido',
    ],
    objetivos: [
      'Qualificar intenção e estilo antes do orçamento',
      'Educar sobre linha e ocasião de uso',
      'Reduzir negociação só por desconto',
      'Fortalecer posicionamento da marca',
      'Aumentar confiança em presentes e pós-venda',
      'Explicar cuidados e durabilidade',
      'Alinhar equipe e revenda',
      'Entender qual canal priorizar',
    ],
  },
  {
