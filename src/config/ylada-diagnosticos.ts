...
export const DIAGNOSTICOS: Record<string, DiagnosticoConfig> = {
  comunicacao: {
    ...
    perguntas: [
      ...
      { id: 'area', texto: 'Qual é sua profissão ou área de atuação?', opcoes: [{ valor: 0, label: 'Saúde / medicina' }, { valor: 1, label: 'Psicologia' }, { valor: 7, label: 'Psicanálise' }, { valor: 2, label: 'Estética / beleza' }, { valor: 3, label: 'Nutrição' }, { valor: 4, label: 'Fitness' }, { valor: 5, label: 'Consultoria / coaching' }, { valor: 6, label: 'Outro' }] },
...
export const PERGUNTA_AREA: Pergunta = {
  ...
  opcoes: [
    ...
    { valor: 1, label: 'Psicologia' },
    { valor: 7, label: 'Psicanálise' },
