 ...
 * refresh de linguagem leiga: **427**; meta/cache/schema/memória: **428** (paridade com corporal nas migrações **425** e **426**).
 * Verificação SQL dos pacotes: `scripts/verify-capilar-packaged-diagnosis.sql`.
