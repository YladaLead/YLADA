...
export const PROFESSION_HEADER: Partial<Record<ProfessionCode, ProfessionHeaderCopy>> = {
  ...
  psicanalise: {
    title: 'Perfil estratégico para psicanalistas',
    subtitle: 'Setting, público e captação ética.',
  },
  coach: {
...
export const PROFESSION_IDENTITY: Partial<Record<ProfessionCode, ProfessionIdentityCopy>> = {
  ...
  psicanalise: { youAre: 'Psicanálise', objective: 'Estruturar seu consultório e o processo com estratégia.' },
...
export const STEP_COPY_BY_PROFESSION: Record<string, Partial<Record<ProfessionCode, StepCopyEntry>>> = {
  contexto: {
    ...
    psicanalise: {
      stepHeaderPart: 'Setting e atendimento',
      title: 'Como você estrutura seu trabalho em psicanálise?',
      description: 'Isso ajuda o Noel a orientar você com foco em posicionamento e primeiros contatos alinhados ao processo analítico.',
    },
    coach: {
  ...
  especialidade: {
    ...
    psicanalise: { stepHeaderPart: 'Formação e público' },
  ...
  diagnostico: {
    ...
    psicanalise: { stepHeaderPart: 'Diagnóstico' },
  ...
  metas_modelo: {
    ...
    psicanalise: { stepHeaderPart: 'Metas e modelo' },
  ...
  canais_rotina: {
    ...
    psicanalise: { stepHeaderPart: 'Canais e rotina' },
  ...
  observacoes: {
    ...
    psicanalise: { stepHeaderPart: 'Observações' },
...
export const FIELD_LABELS_BY_PROFESSION: Partial<Record<ProfessionCode, Record<string, string>>> = {
  ...
  psicanalise: {
    category: 'Formação e linha',
    sub_category: 'Detalhe opcional (escola, foco clínico)',
    publico_psi: 'Com qual público você trabalha?',
    modalidade_atendimento: 'Modalidade de sessão',
    tempo_atuacao_anos: 'Há quantos anos você atua como psicanalista?',
    modelo_atuacao: 'Setting e frequência',
    dor_principal: 'O que mais está travando?',
    prioridade_atual: 'O que você quer destravar primeiro?',
    fase_negocio: 'Fase da sua prática',
    metas_principais: 'Metas principais',
    objetivos_curto_prazo: 'Objetivos curto e médio prazo',
    capacidade_semana: 'Quantas sessões por semana?',
    ticket_medio: 'Valor médio da sessão (R$)',
    canais_principais: 'Onde seus analisandos te encontram?',
    rotina_atual_resumo: 'Como está sua rotina hoje?',
    observacoes: 'Algo mais que o Noel deve saber?',
  },
  coach: {
...
const LIBERAL_FLOW_PSICANALISE: ProfileFlowConfig = {
  flow_id: 'liberal_v1',
  flow_version: 1,
  profile_type: 'liberal',
