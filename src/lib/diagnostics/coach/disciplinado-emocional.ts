/**
 * DIAGNÓSTICOS: Você é mais disciplinado ou emocional com a comida? - ÁREA COACH
 *
...
export const disciplinadoEmocionalDiagnosticos: DiagnosticosPorFerramenta = {
  coach: {
    ...
    perfilEmocional: {
      ...
      causaRaiz:
        '🔍 CAUSA RAIZ: Comer sem fome física, pular refeições e buscar conforto na comida indicam falta de estratégias emocionais paralelas ao plano de bem-estar.',
      acaoImediata:
      ...
      proximoPasso:
        '🎯 PRÓXIMO PASSO: Junto com o Coach de bem-estar, você constrói uma estratégia integrada (alimentação + emoções) para retomar o controle com acolhimento.'
    },
    perfilImpulsivo: {
      diagnostico:
