/**
 * DIAGNÓSTICOS: Guia Nutracêutico - ÁREA COACH
 */
...
export const guiaNutraceuticoDiagnosticos: DiagnosticosPorFerramenta = {
  coach: {
    ...
    altoInteresse: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Mantenha interesse atual e evolua para nutracêuticos de precisão. Considere avaliação de bem-estar avançada para protocolo personalizado que maximiza resultados preventivos',
