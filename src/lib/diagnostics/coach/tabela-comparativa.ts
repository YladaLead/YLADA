/**
 * DIAGNÓSTICOS: Tabela Comparativa - ÁREA COACH
 */
...
export const tabelaComparativaDiagnosticos: DiagnosticosPorFerramenta = {
  coach: {
    comparacaoBasica: {
      ...
      causaRaiz: '🔍 CAUSA RAIZ: Necessidade de entender diferenças entre produtos básicos e essenciais. Pesquisas mostram que comparações estruturadas aumentam a probabilidade de escolhas adequadas em até 60%. Uma avaliação de bem-estar identifica exatamente quais produtos são mais relevantes para suas necessidades específicas'
      acaoImediata: '⚡ AÇÃO IMEDIATA: Compare produtos essenciais considerando suas necessidades reais. Busque avaliação de bem-estar para receber orientações personalizadas sobre quais produtos comparar de acordo com seu perfil',
    ...
    comparacaoAvancada: {
      ...
      causaRaiz: '🔍 CAUSA RAIZ: Necessidade de entender diferenças entre produtos especializados e identificar melhor custo-benefício. Estudos indicam que comparações detalhadas podem aumentar eficácia de escolhas em até 45%. Uma análise de bem-estar identifica exatamente quais produtos especializados são mais eficazes para seu perfil'
      acaoImediata: '⚡ AÇÃO IMEDIATA: Compare produtos especializados considerando qualidade, composição e eficácia. Considere avaliação de bem-estar para identificar quais produtos direcionados oferecem melhor relação custo-benefício para você',
    ...
    comparacaoPremium: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Compare produtos de elite considerando qualidade premium, composição avançada e eficácia comprovada. Considere avaliação de bem-estar avançada para protocolo personalizado que maximiza resultados',
