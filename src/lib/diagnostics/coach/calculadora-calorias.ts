...
export const calculadoraCaloriasDiagnosticos: DiagnosticosPorFerramenta = {
  coach: {
    ...
    manutencaoCalorica: {
      ...
      causaRaiz: '🔍 CAUSA RAIZ: Consumo calórico adequado para manutenção do peso atual estabelecido. Pesquisas mostram que otimizações na qualidade nutricional, mesmo mantendo calorias, podem melhorar composição corporal e saúde metabólica. Uma análise de bem-estar identifica oportunidades específicas para você.',
