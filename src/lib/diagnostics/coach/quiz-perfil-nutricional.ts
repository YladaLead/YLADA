/**
 * DIAGNÓSTICOS: Quiz Perfil Nutricional - ÁREA COACH
 */
...
export const quizPerfilNutricionalDiagnosticos: DiagnosticosPorFerramenta = {
  coach: {
    ...
    absorcaoOtimizada: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Continue a rotina atual e considere avaliação preventiva para introduzir estratégias de bem-estar avançadas que sustentam resultados a longo prazo',
