/**
 * DIAGNÓSTICOS: Qual é o seu Tipo de Fome - ÁREA COACH
 * 
...
export const tipoFomeDiagnosticos: DiagnosticosPorFerramenta = {
  coach: {
    ...
    fomeFisica: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Considere uma avaliação de bem-estar preventiva para otimizar seu controle de fome. Umo Coach de bem-estar pode criar estratégias personalizadas, ajustar plano alimentar adequado e fornecer orientações para manter sua excelente condição ao longo do tempo. A prevenção garante qualidade de vida contínua.',
      proximoPasso: '🎯 PRÓXIMO PASSO: Mantenha seu excelente controle de fome com estratégias preventivas personalizadas. Agende uma avaliação de bem-estar para receber orientações adequadas ao seu perfil. A prevenção é o melhor investimento para sua saúde a longo prazo!'
    }
  }
}
