/**
 * DIAGNÓSTICOS: Diagnóstico de Parasitose - ÁREA COACH
 *
...
export const diagnosticoParasitoseDiagnosticos: DiagnosticosPorFerramenta = {
  coach: {
    parasitoseBasica: {
      diagnostico:
        '🦠 DIAGNÓSTICO: Seus sinais indicam possível parasitose inicial. Um acompanhamento de bem-estar especializado é essencial para confirmar o quadro e iniciar um protocolo seguro.',
      causaRaiz:
      ...
      acaoImediata:
        '⚡ AÇÃO IMEDIATA: Agende uma avaliação de bem-estar para revisar histórico de exposição, hábitos de higiene e alimentação. A profissional orienta exames específicos e prepara um protocolo inicial antiparasitário.',
      proximoPasso:
    ...
    parasitoseModerada: {
      ...
      acaoImediata:
        '⚡ AÇÃO IMEDIATA: Busque avaliação de bem-estar para receber um plano direcionado, validar exames e alinhar com outros profissionais de saúde quando necessário.',
      proximoPasso:
    ...
    parasitoseAvancada: {
      ...
      acaoImediata:
        '⚡ AÇÃO IMEDIATA: Procure umo Coach de bem-estar funcional para coordenar exames completos, alinhar condutas com o médico e definir o plano de suporte de bem-estar e detox adequado.',
      proximoPasso:
