/**
 * DIAGNÓSTICOS: Tabela de Metas Semanais - ÁREA COACH
 */
...
export const tabelaMetasSemanaisDiagnosticos: DiagnosticosPorFerramenta = {
  coach: {
    metasBasicas: {
      ...
      causaRaiz: '🔍 CAUSA RAIZ: Excesso de metas ou falta de clareza reduz aderência. Evidências mostram que 3-5 metas simples por semana com critérios claros aumentam a consistência em até 40%. Uma avaliação de bem-estar identifica quais áreas (água, sono, movimento, proteína, vegetais) trazem maior impacto para você',
