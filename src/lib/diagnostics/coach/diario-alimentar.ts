/**
 * DIAGNÓSTICOS: Diário Alimentar - ÁREA COACH
 */
...
export const diarioAlimentarDiagnosticos: DiagnosticosPorFerramenta = {
  coach: {
    diarioBasico: {
      ...
      causaRaiz: '🔍 CAUSA RAIZ: Falta de registro de hábitos alimentares e conexões emocionais pode estar afetando sua relação com a comida. Estudos mostram que pessoas que registram alimentos e sentimentos têm 35% mais sucesso em identificar padrões emocionais relacionados à alimentação. Uma avaliação de bem-estar identifica exatamente quais padrões emocionais e alimentares precisam ser trabalhados',
      acaoImediata: '⚡ AÇÃO IMEDIATA: Comece a registrar sua alimentação e sentimentos relacionados diariamente por pelo menos 30 dias. Busque avaliação de bem-estar para receber orientações sobre como interpretar as conexões entre emoções e alimentação identificadas no diário',
    ...
    diarioModerado: {
      ...
      causaRaiz: '🔍 CAUSA RAIZ: Padrões emocionais intermediários relacionados à alimentação podem estar impactando seus resultados nutricionais sem você perceber. Pesquisas indicam que registro detalhado de alimentos, horários e sentimentos pode melhorar compreensão de padrões emocionais-alimentares em até 45% quando adequadamente implementado. Uma análise de bem-estar identifica exatamente quais padrões específicos são mais relevantes para você',
      acaoImediata: '⚡ AÇÃO IMEDIATA: Mantenha registro básico e adicione informações sobre horários, situações e sentimentos específicos. Considere avaliação de bem-estar para aprender a interpretar padrões emocionais intermediários e identificar oportunidades de transformação da relação com a comida',
    ...
    diarioAvancado: {
      ...
      causaRaiz: '🔍 CAUSA RAIZ: Padrões emocionais complexos relacionados à alimentação requerem registro detalhado para transformação eficaz. Estudos mostram que registro avançado de alimentos, sentimentos, situações e timing pode resultar em melhorias que potencializam transformação da relação com comida em até 60%. Uma avaliação de bem-estar avançada identifica oportunidades específicas de transformação baseadas em padrões emocionais-alimentares complexos',
      acaoImediata: '⚡ AÇÃO IMEDIATA: Implemente diário avançado com registro detalhado de alimentos, sentimentos, situações e timing de bem-estar. Considere avaliação de bem-estar avançada para interpretação profissional dos padrões emocionais complexos identificados',
