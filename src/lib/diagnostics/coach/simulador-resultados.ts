/**
 * DIAGNÓSTICOS: Simulador de Resultados - ÁREA COACH
 */
...
export const simuladorResultadosDiagnosticos: DiagnosticosPorFerramenta = {
  coach: {
    resultadosBasicos: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Visualize resultados básicos alcançáveis através de mudanças simples (ex.: beber mais água, incluir vegetais, manter horários). Busque avaliação de bem-estar para receber simulação personalizada de resultados baseada no seu perfil atual',
    ...
    resultadosModerados: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Visualize resultados moderados através de mudanças estratégicas (ex.: timing de bem-estar, qualidade alimentar, distribuição de macronutrientes). Considere avaliação de bem-estar para receber simulação personalizada de resultados baseada no seu perfil',
    ...
    resultadosAvancados: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Visualize resultados avançados através de estratégias refinadas (ex.: nutrigenômica, timing de precisão, combinações estratégicas). Considere avaliação de bem-estar avançada para receber simulação personalizada de resultados de elite',
