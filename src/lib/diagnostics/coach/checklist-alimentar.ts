/**
 * DIAGNÓSTICOS: Checklist Alimentar - ÁREA COACH
 */
...
export const checklistAlimentarDiagnosticos: DiagnosticosPorFerramenta = {
  coach: {
    alimentacaoDeficiente: {
      ...
      causaRaiz: '🔍 CAUSA RAIZ: Hábitos alimentares inadequados e possíveis deficiências nutricionais. Estudos indicam que 70% das doenças crônicas estão relacionadas à alimentação inadequada. Uma avaliação de bem-estar completa identifica exatamente quais deficiências estão presentes e como corrigir',
      acaoImediata: '⚡ AÇÃO IMEDIATA: Implemente mudanças alimentares básicas gradualmente. Busque avaliação de bem-estar para receber um plano personalizado que corrija deficiências de forma segura e adequada ao seu estilo de vida',
    ...
    alimentacaoModerada: {
      ...
      causaRaiz: '🔍 CAUSA RAIZ: Alguns hábitos alimentares podem ser otimizados e pequenas deficiências nutricionais podem estar presentes. Pesquisas mostram que otimizações estratégicas podem melhorar marcadores de saúde em até 30%. Uma análise de bem-estar identifica oportunidades específicas para você',
      acaoImediata: '⚡ AÇÃO IMEDIATA: Otimize hábitos alimentares e corrija possíveis deficiências. Considere avaliação de bem-estar para identificar ajustes estratégicos que maximizem resultados',
