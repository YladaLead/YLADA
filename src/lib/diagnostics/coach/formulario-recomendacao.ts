/**
 * DIAGNÓSTICOS: Formulário de Recomendação - ÁREA COACH
 */
...
export const formularioRecomendacaoDiagnosticos: DiagnosticosPorFerramenta = {
  coach: {
    recomendacaoBasica: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Receba recomendações nutricionais básicas direcionadas baseadas no seu perfil atual. Busque avaliação de bem-estar para receber recomendações personalizadas que se adaptam às suas necessidades fundamentais e objetivos',
    ...
    recomendacaoModerada: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Receba recomendações nutricionais moderadas com estratégias específicas baseadas no seu perfil detalhado. Considere avaliação de bem-estar para recomendações direcionadas que potencializam resultados através de otimizações estratégicas',
    ...
    recomendacaoAvancada: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Receba recomendações nutricionais avançadas com estratégias complexas baseadas na análise profunda do seu perfil. Considere avaliação de bem-estar avançada para recomendações especializadas que maximizam resultados através de refinamentos e otimizações de elite',
