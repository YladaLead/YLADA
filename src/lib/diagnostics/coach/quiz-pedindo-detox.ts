/**
 * DIAGNÓSTICOS: Seu corpo está pedindo Detox? - ÁREA COACH
 *
...
export const quizPedindoDetoxDiagnosticos: DiagnosticosPorFerramenta = {
  coach: {
    ...
    corpoPedindoDetox: {
      ...
      proximoPasso:
        '🎯 PRÓXIMO PASSO: Marque uma consulta de bem-estar para construir um plano detox completo com fases de reparo intestinal, suporte hepático e acompanhamento contínuo.'
    }
  }
}
