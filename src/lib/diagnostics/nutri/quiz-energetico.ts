/**
 * DIAGNÓSTICOS: Quiz Energético - ÁREA NUTRI
 */
...
export const quizEnergeticoDiagnosticos: DiagnosticosPorFerramenta = {
  nutri: {
    energiaBaixa: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Observe sua disposição ao longo do dia e evite auto suplementação. Procure avaliação profissional para identificar possíveis carências.',
    ...
    energiaModerada: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Observe como sono e rotina influenciam sua energia. Pequenos ajustes com orientação podem otimizar seu rendimento diário.',
    ...
    energiaAlta: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Mantenha seus hábitos equilibrados e atenção ao descanso. Avaliações preventivas ajudam a manter sua vitalidade.',
