...
export const quizEnergeticoDiagnosticos: DiagnosticosPorFerramenta = {
  nutri: {
    energiaBaixa: {
      ...
      acaoImediata: 'Observe sua disposição ao longo do dia e evite auto suplementação.
Procure avaliação profissional para identificar possíveis carências.',
    ...
    energiaModerada: {
      ...
      acaoImediata: 'Observe como sono e rotina influenciam sua energia.
Pequenos ajustes com orientação podem otimizar seu rendimento diário.',
    ...
    energiaAlta: {
      ...
      acaoImediata: 'Mantenha seus hábitos equilibrados e atenção ao descanso.
