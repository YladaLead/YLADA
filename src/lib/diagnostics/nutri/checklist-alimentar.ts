...
export const checklistAlimentarDiagnosticos: DiagnosticosPorFerramenta = {
  nutri: {
    alimentacaoDeficiente: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Observe seus hábitos alimentares e evite mudanças drásticas por conta própria. Busque avaliação profissional para corrigir deficiências de forma segura.',
    ...
    alimentacaoModerada: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Reflita sobre sua rotina alimentar e identifique pequenas melhorias. Ajustes guiados por um profissional podem maximizar resultados.',
    ...
    alimentacaoEquilibrada: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Mantenha seus bons hábitos e atenção ao corpo. Avaliações periódicas ajudam a potencializar a saúde a longo prazo.',
