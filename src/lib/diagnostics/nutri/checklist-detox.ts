/**
 * DIAGNÓSTICOS: Checklist Detox - ÁREA NUTRI
 */
...
export const checklistDetoxDiagnosticos: DiagnosticosPorFerramenta = {
  nutri: {
    baixaToxicidade: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Mantenha seus hábitos equilibrados e observe como o corpo responde. Avaliações periódicas ajudam a sustentar bons resultados.',
    ...
    toxicidadeModerada: {
      diagnostico: '📋 DIAGNÓSTICO: Sinais de acúmulo moderado de toxinas que precisam de intervenção estratégica.',
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Observe sinais como cansaço ou inchaço e evite protocolos por conta própria. Busque orientação profissional para um detox seguro e adequado ao seu perfil.',
    ...
    altaToxicidade: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Redobre o cuidado com alimentação e rotina. Procure avaliação profissional para um plano seguro e individualizado.',
