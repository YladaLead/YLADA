...
export const perfilIntestinoDiagnosticos: DiagnosticosPorFerramenta = {
  nutri: {
    ...
    intestinoSensivel: {
      ...
      proximoPasso:
        '🎯 PRÓXIMO PASSO: Solicite uma análise nutricional completa para mapear intolerâncias, definir uso de probióticos específicos e alinhar um protocolo de restauração intestinal sob acompanhamento profissional.'
    },
    disbioseIntestinal: {
      diagnostico:
      ...
      acaoImediata:
        '⚡ AÇÃO IMEDIATA: Busque avaliação profissional para identificar causas e restaurar o equilíbrio da microbiota. Evite protocolos ou suplementações sem acompanhamento.',
      proximoPasso:
