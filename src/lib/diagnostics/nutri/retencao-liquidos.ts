...
export const retencaoLiquidosDiagnosticos: DiagnosticosPorFerramenta = {
  nutri: {
    ...
    retencaoModerada: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Reflita sobre consumo de sal e alimentos industrializados. Pequenos ajustes com orientação podem ajudar no equilíbrio hídrico.',
