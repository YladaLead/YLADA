...
export const perfilMetabolicoDiagnosticos: DiagnosticosPorFerramenta = {
  nutri: {
    metabolismoLento: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Observe seu padrão alimentar e nível de atividade. Busque avaliação profissional para identificar ajustes seguros e eficazes.',
