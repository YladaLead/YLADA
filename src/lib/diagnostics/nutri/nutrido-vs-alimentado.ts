...
export const nutridoVsAlimentadoDiagnosticos: DiagnosticosPorFerramenta = {
  nutri: {
    ...
    bemNutrido: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Mantenha variedade e equilíbrio nas escolhas alimentares. Continue observando sinais de energia e bem-estar.',
