...
export const quizInterativoDiagnosticos: DiagnosticosPorFerramenta = {
  nutri: {
    metabolismoLento: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Observe seu nível de energia e ritmo diário. Evite auto-suplementação e busque avaliação para definir ajustes seguros.',
    ...
    metabolismoEquilibrado: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Mantenha seus hábitos e observe como o corpo responde. Pequenos ajustes com orientação profissional podem potencializar seus resultados.',
    ...
    metabolismoAcelerado: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Observe sinais de cansaço ou fome frequente. Busque orientação profissional para equilibrar energia e rotina alimentar.',
