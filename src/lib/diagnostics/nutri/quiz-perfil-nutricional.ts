...
export const quizPerfilNutricionalDiagnosticos: DiagnosticosPorFerramenta = {
  nutri: {
    absorcaoBaixa: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Observe sinais como cansaço ou digestão lenta. Busque avaliação profissional para entender e corrigir possíveis falhas de absorção.',
    ...
    absorcaoModerada: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Reflita sobre sua rotina alimentar e digestiva. Pequenos ajustes com orientação profissional podem otimizar sua absorção.',
