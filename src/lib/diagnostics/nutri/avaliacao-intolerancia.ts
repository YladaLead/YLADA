...
export const avaliacaoIntoleranciaDiagnosticos: DiagnosticosPorFerramenta = {
  nutri: {
    altaSuspeitaIntolerancia: {
      ...
      plano7Dias: '📅 PLANO 7 DIAS: Protocolo inicial de eliminação controlada com identificação de alimentos problemáticos, plano alimentar adequado ao seu perfil de intolerância, cronograma de reintrodução controlada, estratégias para manter nutrição adequada mesmo com restrições e acompanhamento para monitorar melhorias. O suporte nutricional é fundamental para uma transição segura e eficaz.',
      suplementacao: '💊 SUPLEMENTAÇÃO: A necessidade só é definida após avaliação nutricional completa. Multivitamínicos, probióticos e enzimas digestivas podem ser considerados quando há indicação, mas sempre de acordo com a individualidade biológica e necessidades específicas identificadas na consulta.',
      alimentacao: '🍎 ALIMENTAÇÃO: Um plano alimentar personalizado considera suas intolerâncias identificadas. Priorize alimentos seguros, evite alimentos problemáticos e mantenha variedade nutricional mesmo com restrições. Uma nutricionista ajusta quantidades e combinações ideais para você, garantindo nutrição completa mesmo com restrições alimentares.',
    ...
    intoleranciaModerada: {
      ...
      plano7Dias: '📅 PLANO 7 DIAS: Protocolo inicial com identificação de padrões alimentares problemáticos, estratégias práticas para otimizar sua alimentação, plano alimentar adequado, cronograma de observação e ajustes, e acompanhamento para monitorar melhorias. O acompanhamento nutricional ajuda a identificar conexões sutis entre alimentos e sintomas.',
      suplementacao: '💊 SUPLEMENTAÇÃO: A necessidade só é definida após avaliação nutricional. Probióticos, enzimas digestivas e multivitamínicos podem ser considerados quando há indicação, mas sempre de acordo com a individualidade biológica e necessidades específicas identificadas na consulta.',
      alimentacao: '🍎 ALIMENTAÇÃO: Um plano alimentar personalizado considera suas sensibilidades moderadas. Priorize alimentos bem tolerados, estratégias para identificar alimentos problemáticos e combinações que melhoram digestão. Uma nutricionista ajusta quantidades e combinações ideais para você, criando hábitos alimentares que promovem bem-estar contínuo.',
    ...
    baixaProbabilidadeIntolerancia: {
      ...
      plano7Dias: '📅 PLANO 7 DIAS: Protocolo preventivo com otimização nutricional, estratégias para manter saúde digestiva, plano alimentar adequado, orientações sobre combinações alimentares ideais e acompanhamento para garantir que você mantenha sua excelente tolerância alimentar. A prevenção é a melhor estratégia.',
      suplementacao: '💊 SUPLEMENTAÇÃO: A necessidade só é definida após avaliação nutricional. Probióticos preventivos e multivitamínicos podem ser considerados quando há indicação, mas sempre de acordo com a individualidade biológica e necessidades específicas identificadas na consulta.',
      alimentacao: '🍎 ALIMENTAÇÃO: Um plano alimentar preventivo considera sua boa tolerância atual. Priorize otimização nutricional, estratégias para manter excelente tolerância alimentar e combinações alimentares ideais. Uma nutricionista ajusta quantidades e combinações para manter sua saúde digestiva em excelência.',
