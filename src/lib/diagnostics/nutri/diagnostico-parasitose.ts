  ...
  nutri: {
    parasitoseBasica: {
      ...
      acaoImediata:
        ...
        '📅 PLANO 7 DIAS: Protocolo básico com identificação de gatilhos, ajustes alimentares antiparasitários, hidratação estratégica, acompanhamento de sintomas e indicação de exames laboratoriais quando necessário.',
        '💊 SUPLEMENTAÇÃO: Probióticos, multivitamínico e ômega-3 podem ser considerados, sempre com prescrição profissional, para reforçar imunidade e auxiliar a recuperação intestinal.',
        '🍎 ALIMENTAÇÃO: Priorize alimentos naturais com ação antiparasitária como alho, cúrcuma, gengibre e fibras solúveis. A nutricionista personaliza quantidades e combinações para proteger a microbiota.'
      proximoPasso:
    ...
    parasitoseModerada: {
      ...
      acaoImediata:
        ...
        '📅 PLANO 7 DIAS: Protocolo moderado com ajustes alimentares mais rígidos, diário de sintomas, indicação de exames parasitológicos em série e cronograma de acompanhamento.',
        '💊 SUPLEMENTAÇÃO: Probióticos específicos, moduladores imunológicos e fitoterápicos antiparasitários podem ser avaliados, sempre com prescrição individual.',
        '🍎 ALIMENTAÇÃO: Foco em alimentação funcional antiparasitária, restrição temporária de açúcares simples e inclusão de fibras e especiarias com ação antimicrobiana.'
      proximoPasso:
    ...
    parasitoseAvancada: {
      ...
      acaoImediata:
        ...
        '📅 PLANO 7 DIAS: Protocolo avançado com rotinas de observação, planejamento alimentar terapêutico, hidratação estratégica, suplementação guiada e preparo para o tratamento médico.',
        '💊 SUPLEMENTAÇÃO: Pode incluir fitoterápicos antiparasitários, nutracêuticos imunomoduladores e protocolos de suporte hepático, sempre com prescrição individualizada.',
        '🍎 ALIMENTAÇÃO: Alimentação terapêutica antiparasitária rica em compostos bioativos, fibras específicas e estratégias de detox suave para auxiliar na eliminação dos patógenos.'
      proximoPasso:
