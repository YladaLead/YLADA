...
export const quizBemEstarDiagnosticos: DiagnosticosPorFerramenta = {
  nutri: {
    bemEstarBaixo: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Observe seus níveis de energia, sono e disposição. Busque avaliação profissional para identificar e corrigir possíveis desequilíbrios.',
    ...
    bemEstarModerado: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Reflita sobre sua rotina e como ela afeta seu bem-estar. Pequenos ajustes com orientação profissional podem gerar grande diferença.',
    ...
    bemEstarAlto: {
      ...
      acaoImediata: '⚡ AÇÃO IMEDIATA: Mantenha sua rotina equilibrada e o cuidado com o corpo. Avaliações periódicas ajudam a sustentar resultados a longo prazo.',
