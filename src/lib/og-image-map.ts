...
export const OG_IMAGE_SLUG_MAP: Record<string, string> = {
  ...
  // Pro Líderes (bloco 2 - vendas)
  'desconforto-pos-refeicao': 'diagnostico-sintomas-intestinais.png',
  'inchaço-manha': 'retencao-liquidos.png',
  'inchaco-manha': 'retencao-liquidos.png',
  'ansiedade-doce': 'avaliacao-emocional.jpg',
  'mente-cansada': 'hype-energia-foco.jpg',
  'falta-disposicao-treinar': 'hype-pre-treino.jpg',
  'trabalho-noturno': 'energia-tarde.jpg',
  'rotina-estressante': 'avaliacao-sono-energia.jpg',
  'maes-ocupadas': 'hype-rotina-produtiva.jpeg',
  'fim-tarde-sem-energia': 'energia-tarde.jpg',
  'sedentarismo': 'avaliacao-emagrecimento-consciente.jpg',
  ...
  'disciplinado-emocional-comida': 'avaliacao-emocional.jpg',
  'nutrido-vs-alimentado': 'nutrido-vs-alimentado.jpg',
  'alimentacao-rotina': 'alimentacao-rotina.jpg',
  'tipo-fome': 'tipo-fome.jpg',
  'perfil-intestino': 'perfil-intestino.jpg',
  'quiz-bem-estar': 'quiz-wellness-profile.jpg',
  'quiz-perfil-nutricional': 'quiz-nutrition-assessment.jpg',
  'quiz-detox': 'cardapio-detox.jpg',
  'quiz-energetico': 'hype-energia-foco.jpg',
  'avaliacao-inicial': 'template-avaliacao-inicial.jpg',
  'desafio-21-dias': 'template-desafio-21dias.jpg',
  'desafio-7-dias': 'template-desafio-7dias.jpg',
  'descubra-perfil-bem-estar': 'quiz-wellness-profile.jpg',
  'diagnostico-eletrolitos': 'diagnostico-eletrolitos.jpg',
  'diagnostico-parasitose': 'diagnostico-parasitose.jpg',
  'diagnostico-sintomas-intestinais': 'diagnostico-sintomas-intestinais.png',
  'calc-hidratacao': 'calc-hidratacao.jpg',
  'calc-calorias': 'calc-calorias.jpg',
  'calc-imc': 'calc-imc.jpg',
  'calc-proteina': 'calc-proteina.jpg',
  'pronto-emagrecer': 'pronto-emagrecer.jpg',
  'avaliacao-fome-emocional': 'avaliacao-emocional.jpg',
  'avaliacao-intolerancias-sensibilidades': 'avaliacao-intolerancia.jpg',
  'avaliacao-perfil-metabolico': 'avaliacao-perfil-metabolico.jpg',
  'avaliacao-sono-energia': 'avaliacao-sono-energia.jpg',
  ...
  // Pro Líderes (bloco 1 - vendas): usar as mesmas imagens OG do Wellness
  'energia-matinal': 'energia-tarde.jpg',
  'troca-cafe': 'energia-tarde.jpg',
  'anti-cansaco': 'energia-tarde.jpg',
  'rotina-puxada': 'hype-rotina-produtiva.jpeg',
  'foco-concentracao': 'hype-energia-foco.jpg',
  'motoristas': 'energia-tarde.jpg',
  'metabolismo-lento': 'avaliacao-perfil-metabolico.jpg',
  'barriga-pesada': 'diagnostico-sintomas-intestinais.png',
  'retencao-inchaço': 'retencao-liquidos.png',
  'retencao-inchaco': 'retencao-liquidos.png',
