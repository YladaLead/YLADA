...
- Pense em **distribuidores em campo**: mensagens curtas, copiáveis, próximo passo claro.`
      : `CONTEXTO MMN / REDE
...
- Se houver «CONTEXTO ESPECÍFICO:» (ex.: parou de responder), deixe isso explícito na sequência onde fizer sentido.
