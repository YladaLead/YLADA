...
//   - perfil-metabolico  ✅ (1 fluxo ESPECIAL: avaliação por faixa de score → perfil; outcomes já no 436)
//
...
import { FLUXOS_VENDAS_METABOLICO } from './blocos/perfil-metabolico'
...
export {
  BLOCO_PERFIL_METABOLICO,
  FLUXOS_VENDAS_METABOLICO,
  FLUXOS_VENDAS_METABOLICO_POR_ID,
} from './blocos/perfil-metabolico'
