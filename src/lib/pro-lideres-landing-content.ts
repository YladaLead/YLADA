...
/** Seção de cards desativada — headline já faz o trabalho de provocação. */
export const PRO_LIDERES_LANDING_QUESTIONS: readonly string[] = []

export const PRO_LIDERES_LANDING_PHILOSOPHY_TITLE = 'Inovação de comportamento em campo'

export const PRO_LIDERES_LANDING_PHILOSOPHY_INTRO =
...
export const PRO_LIDERES_LANDING_SECONDARY_CTA = 'Já sou cliente — quero entrar no painel'
